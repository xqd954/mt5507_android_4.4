...
public class MediaScannerService extends Service implements Runnable
{
    ...
    private void updatescan(String directories, String volumeName) {
		...
		MediaScanner scanner = createMediaScanner(); 
                scanner.updatescan(directories, volumeName);
            } catch (Exception e) {
    ...
    private final class ServiceHandler extends Handler
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            String updatapath = arguments.getString("updatapath");
            ...
            try {
                ...
                } else if (updatapath != null) {
                    Log.d(TAG, "updatescan path is :"+updatapath);
                    updatescan(updatapath, MediaProvider.EXTERNAL_VOLUME);
                } else {
