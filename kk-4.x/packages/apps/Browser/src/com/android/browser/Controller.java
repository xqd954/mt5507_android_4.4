...
public class Controller
    ...
    int getMaxTabs() {
        ...
        if (0 != SystemProperties.get("mtk.browser.lowMemoryMode").length()) {
            lowMemoryMode = Integer.parseInt(SystemProperties.get("mtk.browser.lowMemoryMode"));
        }

        if (0 != SystemProperties.get("mtk.browser.stress").length()) {
            return 1;
        }
    ...
    public void onPageStarted(Tab tab, WebView view, Bitmap favicon) {
        ...
        // -- MTK_WEBKIT_FIX START --
        Log.i(LOGTAG, "[MTK_WEBKIT] onPageStarted, url = " + tab.getUrl());
        ...
        if (mSettings != null ) {
            mSettings.disablePluginIfNeed(tab.getUrl(), view);
            mSettings.adjustUAStringIfNeed(tab.getUrl(), view);
        }
        // -- MTK_WEBKIT_FIX END --
    ...
    public void onPageFinished(Tab tab) {
        ...
        // -- MTK_WEBKIT_FIX START --
        if (0 != SystemProperties.get("mtk.auto_test").length()) {
            Log.i(LOGTAG, "[MTK_WEBKIT] Browser_is_OK, url = " + tab.getUrl());
        }
        // -- MTK_WEBKIT_FIX END --
    }
