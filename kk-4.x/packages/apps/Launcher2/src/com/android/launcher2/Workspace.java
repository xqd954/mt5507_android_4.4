...
public class Workspace extends SmoothPagedView
    ...
    /* MTK Added start */
    private static final int mDram512Width  = 1920;
    private static final int mDram512Height = 1920;
    /* MTK Added end */
        ...
        new Thread("setWallpaperDimension") {
            public void run() {
                ...
                try{
                    ...
                    Object value = method.invoke(null, "ro.mtk.system.dram512");
                    if (value != null && value.toString().equals("1"))
                    {
                        if(mWallpaperWidth > mDram512Width){
                            mWallpaperWidth = mDram512Width;
                        }

                        if(mWallpaperHeight > mDram512Height){
                            mWallpaperHeight = mDram512Height;
                        }
                    }
                }
                catch(Exception e){
