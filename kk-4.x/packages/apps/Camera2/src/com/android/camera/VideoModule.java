...
public class VideoModule implements CameraModule,
    ...
    private static final String TAG = "CAM_VideoModule2";
    ...
    private void setCameraParameters() {
        ...
        if (fpsRange.length > 0) {
            ...
            String value;
            //value = SystemProperties.get("ro.mtk.camera.isSupportHwVenc", "0");
            value = "0";
            if("0" == value){                    
                Log.v(TAG, "camera set previewFrameRate = 20fps, becuase not support Hw encode");
