...
public:
	...
	//add by 40641
	status_t setComposing3DImpl(int dpy, int threeDType);
	
	static status_t setComposing3D(int dpy,int threeDType){
		return Composer::getInstance().setComposing3DImpl(dpy, threeDType);
	}
...
/**add mtk40641*/
status_t SurfaceComposerClient::setComposing3D(int dpy, int threeDType)
{
	
	return Composer::setComposing3D(dpy,threeDType);
}
