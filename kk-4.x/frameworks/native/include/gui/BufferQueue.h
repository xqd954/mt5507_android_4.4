...
public:
    ...
    void setConsumeBufferFifoSize(int mSize);
    void printBufferStatus();
    bool isBufLockedInVDP(int slotId, int w, int h, int format, int usage);
#endif
    /*
...
#if 0 //#ifdef CC_SUPPORT_TV_STAGEFRIGHT  
    // [mtk40134] lock buffer which is used by VDP
    Fifo resolvedSlotQueue;                   
    uint32_t resolvedSlotQueueSize;           
#define  DEFAULT_MODE  0                          
#define  TV_VDP_KEEP_MODE 1                       
#endif
};
