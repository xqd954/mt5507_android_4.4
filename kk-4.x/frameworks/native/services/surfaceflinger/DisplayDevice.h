...
public:
	...
	enum{
		COMPOSING3DNORMAL = 0x00,
		COMPOSING3DSIDEBYSIDE = 0x01,
		COMPOSING3DTOPANBOTTUM = 0x02,
	};
    DisplayDevice(
	...
	//get compose 3D type add by 40641
	int getComposing3DType() const;
	...
	status_t 				setComposing3D(uint32_t threeDType); //40641 3D
...
private:
	...
	int  mComposing3DType;	//add by 40641 stereo3D
};
