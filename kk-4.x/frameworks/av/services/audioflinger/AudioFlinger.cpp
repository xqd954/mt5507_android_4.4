...
//mute system key ,just for TCL mt5507
   if (uint32_t(streamType) == AUDIO_STREAM_SYSTEM) {
        ALOGE("mute system key in Audioflinger%d");
        lStatus = BAD_VALUE;
        goto Exit;
    }
