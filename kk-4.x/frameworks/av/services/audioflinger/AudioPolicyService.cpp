...
status_t AudioPolicyService::setStreamVolumeIndex(audio_stream_type_t stream,
                                                  ...
                                                  audio_devices_t device)
{
	ALOGE("[Audio]AudioPolicyService::setStreamVolumeIndex index is %d",index);
    if (mpAudioPolicy == NULL) {
        return NO_INIT;
    }
    if (!settingsAllowed()) {
...
int AudioPolicyService::setStreamVolume(audio_stream_type_t stream,
                                        ...
                                        int delayMs)
{
	ALOGE("[Audio]AudioPolicyService::setStreamVolume volume is %f",volume);
...
static int aps_set_stream_volume(void *service, audio_stream_type_t stream,
                                     ...
                                     int delay_ms)
{
	ALOGE("[Audio]aps_set_stream_volume volume is %f",volume);
    AudioPolicyService *audioPolicyService = (AudioPolicyService *)service;
