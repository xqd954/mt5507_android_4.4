...
/*MTK BEGIN*/
 public:
       virtual status_t        setSurfaceType(int i4Type);
       virtual status_t        setPlayerType(int i4PlayerType);
       virtual status_t        setVideoRect(int i4left, int i4top, int i4right, int bottom);
...
/*MTK END*/
    private:
        ...
        friend class MetadataRetrieverClient;
...
#endif
        bool isNativeWindowFullScreen;    //add by kangjp,for video fullscreen properties
    }; // Client
...
// ----------------------------------------------------------------------------
    ...
    mutable     Mutex                       mLock;
                ...
                sp<ICrypto>                 mCrypto;
public:
    static Mutex mGetPlayerTypeLock;
};
