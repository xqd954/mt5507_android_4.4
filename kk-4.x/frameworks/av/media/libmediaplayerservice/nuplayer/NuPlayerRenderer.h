...
struct NuPlayer::Renderer : public AHandler {
    ...
    void onCheckRenderBufferStatus();
    void onNotifyStatusChange(const sp<AMessage> &message);
...
private:
    enum {
        kWhatDrainAudioQueue    = 'draA',//Data output and erase
        kWhatDrainVideoQueue    = 'draV',//Data output and erase
        ...
        kWhatPause              = 'paus',
        kWhatResume             = 'resm',
        kWhatCheckRenderBufferStatus = 'crbs',
        kWhatStatusNotify = 'stnf',
    };
    ...
    bool mIsbufferempty;
    bool mNeedCheckBuffer;
    bool mIsSeeking;
    int  mDebugDisableAVsync;
#endif
    int64_t mAveragedelayUs;
    int64_t mTotaleDelayUs;
    int64_t mAveragedelayUs_SampleCount;
    ...
    bool onDrainAudioQueue();//Data output and erase
    void postDrainAudioQueue(int64_t delayUs = 0);

    void onDrainVideoQueue();//Data output and erase
