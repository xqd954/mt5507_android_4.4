...
status_t StagefrightPlayer::assignSWVideoDecoder(bool useSWDec)
{
    ALOGD("%s %s %d",__FUNCTION__,__FILE__,__LINE__);
    //return mPlayer->assignSWVideoDecoder(useSWDec);
    return -1;
}

status_t StagefrightPlayer::assignSWAudioDecoder(bool useSWDec)
{
    ALOGD("%s %s %d",__FUNCTION__,__FILE__,__LINE__);
    return -1;
}

status_t StagefrightPlayer::setSurfaceType(int i4Type)
{
    ALOGD("%s %s %d",__FUNCTION__,__FILE__,__LINE__);
    return -1;
}

status_t StagefrightPlayer::setRMPriority(int i4value)
{
    ALOGD("%s %s %d",__FUNCTION__,__FILE__,__LINE__);
    return -1;
}

status_t StagefrightPlayer::setSpeed(int speed)
{
    ALOGD("%s %s %d",__FUNCTION__,__FILE__,__LINE__);
    //-1, fail, not support.
    return -1;
...
#if 1
bool StagefrightPlayer::canDoTrick(int speed)
{
    ALOGD("%s %s %d",__FUNCTION__,__FILE__,__LINE__);
    return false;
}

bool StagefrightPlayer::canDoSeek(int speed)
{
    ALOGD("%s %s %d",__FUNCTION__,__FILE__,__LINE__);
    return false;
}

bool StagefrightPlayer::step(int amount)
{
    ALOGD("%s %s %d",__FUNCTION__,__FILE__,__LINE__);
    return false;
}
