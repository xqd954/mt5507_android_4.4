...
void MediaCodecList::addMediaCodec(
    ...
    if (!strcmp(name, "OMX.mtk.h265.decoder"))
	{
		//skip MTK.google.h265.decoder
		ALOGD("do not add OMX.mtk.h265.decoder for not SUPPORT HEVC");
		return;
	}
#endif
#endif
...
status_t MediaCodecList::getCodecCapabilities(
    ...
    for (size_t i = 0; i < caps.mColorFormats.size(); ++i) {
	    ...
	    if( (0==info.mIsEncoder)&&( OMX_COLOR_FormatVendorMTKYUV==caps.mColorFormats.itemAt(i)
			|| OMX_COLOR_FormatVendorNV21 == caps.mColorFormats.itemAt(i)
			|| OMX_COLOR_FormatVendorNV12 == caps.mColorFormats.itemAt(i)) )
	    {
