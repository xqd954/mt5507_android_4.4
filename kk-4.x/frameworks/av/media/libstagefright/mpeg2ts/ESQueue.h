...
struct ElementaryStreamQueue {
    enum Mode {
        ...
        VC1_VIDEO,
        AVS_VIDEO,
        PES_METADATA, // now only parse audio album picture
#endif
        MPEG_AUDIO,
        MPEG_VIDEO,
        MPEG4_VIDEO,
	...
	void setDequeueMpegAudioOgm(bool fgEnable);
    #endif
#endif
private:
    struct RangeInfo {
    ...
    sp<ABuffer> dequeueAccessUnitMPEGAudioOgm();
#endif
    ...
    sp<ABuffer> dequeueAccessUnitAVSVideo();
