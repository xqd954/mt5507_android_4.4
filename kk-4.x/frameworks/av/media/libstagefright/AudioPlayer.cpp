...
size_t AudioPlayer::fillBuffer(void *data, size_t size) {
	...
	if ( (mPositionTimeMediaUs >= 5000000) && _fgFirstGT5sec )	//	greater than 5s , print log
	{
		ALOGD("[AudioPlayer]:%s_playing_greater_than_5_seconds\n",__FUNCTION__);
		_fgFirstGT5sec = false;
	}
