...
#if !defined(ANDROID_DEFAULT_CODE) && defined(CC_SUPPORT_TV_STAGEFRIGHT) && defined(MTK_VIDEO_HEVC_SUPPORT)
						onfreeBuffer(portIndex, header);
#endif
...
#if !defined(ANDROID_DEFAULT_CODE) && defined(CC_SUPPORT_TV_STAGEFRIGHT) && defined(MTK_VIDEO_HEVC_SUPPORT)
void SimpleSoftOMXComponent::onfreeBuffer(OMX_U32 portIndex, OMX_BUFFERHEADERTYPE *buffer) {
}
	
void SimpleSoftOMXComponent::onPortFlushForHEVC(OMX_U32 portIndex) {
}
#endif
