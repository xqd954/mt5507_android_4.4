...
//#ifdef ANDROID_DEFAULT_WCP_CODE
...
//#endif
   ...
   Condition mBufferSent;
    ...
    status_t setupHEVCEncoderParameters(const sp<MetaData>& meta);
#endif
#endif
...
#if defined(CC_SUPPORT_TV_STAGEFRIGHT) && !defined(CC_SUPPORT_TV_STAGEFRIGHT) && !defined(ANDROID_DEFAULT_CODE) //limit input buffer when rstp//ANDROID_DEFAULT_CODE
