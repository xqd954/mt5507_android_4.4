...
//Added for besTV
	BES_ERROR_BASE = -5000,
	ERROR_CONNECTED_TIMEOUT				 = BES_ERROR_BASE,
	ERROR_PLAYLIST_TIMEOUT				 = BES_ERROR_BASE - 1,
	ERROR_PLAYLIST_FAILED				 = BES_ERROR_BASE - 2,
	ERROR_PLAYLIST_DOWNLOAD				 = BES_ERROR_BASE - 3,
	ERROR_CONNECTED_FAIL 				 = BES_ERROR_BASE - 8, 
	ERROR_DOWNLOAD_FAIL					 = BES_ERROR_BASE - 9, 
	ERROR_PLAYLIST_PARSE_FAIL			 = BES_ERROR_BASE -10,
