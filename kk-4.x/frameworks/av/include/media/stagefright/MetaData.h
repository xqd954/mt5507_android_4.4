...
enum {
    ...
    kKeyHLSVideoFirestRender = 'v1Rn',       //int64_t, timestamp, http live
...
//#endif
    ...
    kKeyMJPG              = 'mjpg',  // m-jpeg codec specific data
    ...
    kKeyBlockAlign         = 'blal',    //uint32_t
    kKeyFrameSize          = 'frsz',    //uint32_t
#endif    
