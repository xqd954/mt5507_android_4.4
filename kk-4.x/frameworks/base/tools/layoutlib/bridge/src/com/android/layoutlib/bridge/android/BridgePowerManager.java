...
public class BridgePowerManager implements IPowerManager {
	...
	@Override
	public int getShutdownReason() throws RemoteException {
		// pass for now.		
		return 0;
	}
		
	@Override
	public void setShutdownReason(int reason) throws RemoteException {
		// pass for now.
	}
	...
	@Override
    public void setWakeupReason(int ctrl_value) throws RemoteException {
        // pass for now.
	}

	@Override
	public int setPanelOn() throws RemoteException {
        // pass for now.        
        return 0;
	}

	@Override
	public int setPanelOff() throws RemoteException {
        // pass for now.        
        return 0;
	}

	@Override
	public int setAudioMute() throws RemoteException {
        // pass for now.        
        return 0;
	}

	@Override
	public int setAudioUnMute() throws RemoteException {
        // pass for now.        
        return 0;
	}
	
	@Override
	public boolean isBGMState() throws RemoteException {
        // pass for now.        
        return true;
	}
	
	@Override
	public int requestEnterSuspendFromBGM() throws RemoteException {
		// pass for now.		
		return 0;
	}
	
	@Override
	public int requestEnterResumeFromBGM() throws RemoteException {
        // pass for now.        
        return 0;
	}

	@Override
	public int setCustomBGMapplicable(boolean isbgmapplicable) throws RemoteException {
        // pass for now.        
        return 0;
	}
	
	@Override
	public int registerWhiteListByCustomer(String packageName, boolean isWhitelist) throws RemoteException {        
		// pass for now.        
        return 0;
	}
	
	@Override
	public int unregisterWhiteListByCustomer(String packageName) throws RemoteException {
	    // pass for now.        
        return 0;
	}
}
