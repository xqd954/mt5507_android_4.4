...
public final class Bitmap implements Parcelable {
    ...
    public static final int ORIENTATION_NORMAL 			= 1;  //flip:0, mirror:0
    public static final int ORIENTATION_FLIP_HORIZONTAL = 2;  //flip:0, mirror:1
    public static final int ORIENTATION_ROTATE_180 		= 3;  // flip:1, mirror:1
    public static final int ORIENTATION_FLIP_VERTICAL 	= 4;  // flip:1, mirror:0
    public static final int ORIENTATION_TRANSPOSE 		= 5;
    public static final int ORIENTATION_ROTATE_90 		= 6; 
    public static final int ORIENTATION_TRANSVERSE 		= 7; 
    public static final int ORIENTATION_ROTATE_270 		= 8;  

	public boolean compress(CompressFormat format, int quality, int orientation, OutputStream stream) {
        checkRecycled("Can't compress a recycled bitmap");
        // do explicit check before calling the native method
        if (stream == null) {
            throw new NullPointerException();
        ...
        return nativeCompressExif(mNativeBitmap, format.nativeInt, quality,orientation,
                              stream, new byte[WORKING_COMPRESS_STORAGE]);
    }
    ...
    */
    ...
    private static native boolean nativeCompress(int nativeBitmap, int format,
                                            ...
                                            byte[] tempStorage);
	private static native boolean nativeCompressExif(int nativeBitmap, int format,
                                            int quality, int orientation, OutputStream stream,
                                            byte[] tempStorage);
	...
	/**
	 * get native bitmap by mtk add.
	 */
	public final int getNativeBitmap(){
		return mNativeBitmap;
	}
