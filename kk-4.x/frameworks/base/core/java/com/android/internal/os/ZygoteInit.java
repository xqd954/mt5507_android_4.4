...
// ZygoteInit.java log: start 
import java.io.File;
import java.io.FileWriter;
import android.os.SystemProperties;
// ZygoteInit.java log: end
...
public class ZygoteInit {
    ...
    private static boolean startSystemServer()
		...
		// ZygoteInit.java log -- start
		//BootTimeUtil.addTimeStamp("ZG: startSystemServer");
		if (SystemProperties.get("mtk.tms_support").equals("1"))
		{
			try {
				String content ="ZG: startSystemServer";
				String mFilename="/proc/boottime"; 
