...
public interface IActivityManager extends IInterface {
    ...
    public void finishNotBaseActivity(final String packageName, final String baseActivityName) throws RemoteException;
    ...
    /* MTK Added */
    int GET_MTKTASKS_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 183;
	int FINISH_NOT_BASE_ACTIVITY_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION+184;
	int APPLICATION_BINDED = IBinder.FIRST_CALL_TRANSACTION+185;
    /* MTK End */
}
