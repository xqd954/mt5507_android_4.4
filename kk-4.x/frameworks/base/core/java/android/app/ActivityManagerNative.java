...
public abstract class ActivityManagerNative extends Binder implements IActivityManager
{
    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags)
        ...
        /* MTK Added */
        case GET_MTKTASKS_TRANSACTION:
        {
            data.enforceInterface(IActivityManager.descriptor);

            List list = getMtkTasks();
            reply.writeNoException();
            int N = list != null ? list.size() : -1;
            reply.writeInt(N);
            int i;
		...
		case FINISH_NOT_BASE_ACTIVITY_TRANSACTION: {
			data.enforceInterface(IActivityManager.descriptor);
			String packageName = data.readString();
			String baseActivityName = data.readString();
			finishNotBaseActivity(packageName, baseActivityName);
			reply.writeNoException();
			return true;
		}
...
class ActivityManagerProxy implements IActivityManager
{
    ...
    /* MTK Added */
    public List getMtkTasks() throws RemoteException
    {

        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        mRemote.transact(GET_MTKTASKS_TRANSACTION, data, reply, 0);
        reply.readException();
        ArrayList list = null;
	...
	public void finishNotBaseActivity(String packageName, String baseActivityName) throws RemoteException {
		Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        data.writeString(packageName);
        data.writeString(baseActivityName);
        mRemote.transact(FINISH_NOT_BASE_ACTIVITY_TRANSACTION, data, reply, 0);
        reply.readException();
        data.recycle();
        reply.recycle();
	}
