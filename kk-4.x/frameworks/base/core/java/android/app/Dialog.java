...
/*
 * add for voicecontrol
 * mozk@tcl.com
 */
import com.tcl.tclvoicecontrol.framework.RegVoiceControlReceiver;
/**
...
//add dan
	/*@hide*/
    private RegVoiceControlReceiver receiver = null;
    ...
    Dialog(Context context, int theme, boolean createContextThemeWrapper) {
		...
		//add dan
        //add zhengty
        Log.i("dan", "Dialog():new registerVoiceControlReceiver(this)" + this.getClass().toString());
        if ("android.view.VolumePanel".equals(this.getClass().toString())) {
            //todo
        }else{
            receiver = new RegVoiceControlReceiver(this);
        }
    }
    ...
    protected void onStart() {
		...
		if(!flag){
			if (receiver != null) {
				flag=true;
                receiver.registerVoiceControlReceiver();
                receiver.linkPush();
			}
		}
		Log.i("dan","dialog registerVoiceControlReceiver");
		//modify dan
		Log.i("dan","ddialog onStart()");
    ...
    protected void onStop() {
		Log.i("dan","dialog onStop()");
		//dan add
		if(flag){
			if (receiver != null) {
				flag=false;
                receiver.unregisterVoiceControlReceiver();  
                receiver.linkPop();
			}
		}
		Log.i("dan","dialog unregisterVoiceControlReceiver");
		//modify dan
