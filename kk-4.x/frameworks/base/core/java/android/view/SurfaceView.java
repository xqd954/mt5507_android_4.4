...
public class SurfaceView extends View {
	...
	int m3DLayoutFlag = WindowManager.LayoutParams.LAYOUT3D_DISABLED;
    ...
    public SurfaceHolder getHolder() {
        ...
        //MTK Begin
        HolderSourceManager.getInstance().add(mSurfaceHolder, this);
        //MTK END
	...
	/**
	*  flag can be WindowManager.LayoutParams.LAYOUT3D_DISABLED
	*     or WindowManager.LayoutParams.LAYOUT3D_SIDE_BY_SIDE
	*     or  WindowManager.LayoutParams.LAYOUT3D_TOP_AND_BOTTOM
	*     mtk 40641
	*
	*/
	public void set3DLayout(int flag) {				
			m3DLayoutFlag = flag;
			Log.i(TAG, "Surface view set3DLayout to be " + m3DLayoutFlag);
        ...
        if (force || creating || formatChanged || sizeChanged || visibleChanged
            ...
            try {
				...
				// set 3D layout 
				 ...
				 if (DEBUG) Log.i(TAG, "update window set3DLayout: " + mLayout.layout3D);
				 //end
                if (mWindow == null) {
