        ...
        VolumeController
{
    ...
    private static boolean LOGI = true; //[[gaodw@tcl.com. patch from ms628. end]]
    ...
    public VolumePanel(final Context context, AudioService volumeService) {
        ...
        lp.type = LayoutParams.TYPE_SYSTEM_OVERLAY; //TYPE_VOLUME_OVERLAY;
    ...
    protected void onMuteChanged(int streamType, int flags) {
		...
		//[[gaodw@tcl.com. patch from ms628. begin]]
		showMuteView(isMuted(sc.streamType));		
...
/*MTK Start*/
                if(msg.arg2 == (1 << 31)){//hide volume bar
                    forceTimeout();
                }
/*MTK End*/
                break;
	...
	//[[modiby by gaodw@tcl.com. begin]]
//{{lvh@tcl , private => public
    public void forceTimeout() {
    //private void forceTimeout() {
//}}
	//[[modiby by gaodw@tcl.com. end]]
    ...
    public void onProgressChanged(SeekBar seekBar, int progress,
		...
		//[[gaodw@tcl.com patch from ms628. begin]]
        if (LOGI) Log.i(TAG, "progress: " + progress + ", fromUser: " + fromUser);
	...
	//[[gaodw@tcl.com. patch from ms628. begin]]
	private void showMuteView(boolean state) {
    	try {
			if(state) {
            	if(mMuteView !=null) {
					wm.removeView(mMuteView);
					mMuteView = null;
				}
				...
				mMuteView = inflater.inflate(R.layout.tcl_volume_mute, null);
				
				wm.addView(mMuteView, params);
				forceTimeout();
			} else {
				wm.removeView(mMuteView);
				mMuteView = null;
