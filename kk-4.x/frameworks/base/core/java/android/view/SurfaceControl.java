...
public class SurfaceControl {
	...
	/*40641*/
	public static native   void nativeSetComposing3D(int phy, int compose3D);
	...
	/**  set compose3D layer 
	* phy should be 0 in DTV
	* compose3D can be WindowManager.LayoutParams.COMPOSE3D_DISABLED
	* 				    WindowManager.LayoutParams.COMPOSE3D_SIDE_BY_SIDE
	*				    WindowManager.LayoutParams.COMPOSE3D_TOP_AND_BOTTOM
	* 40641*/
	public static void setComposing3D(int phy, int compose3D){
			nativeSetComposing3D(phy,compose3D);
	}
