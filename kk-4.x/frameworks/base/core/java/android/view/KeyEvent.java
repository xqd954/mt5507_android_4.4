...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    /** Key code constant: MTK IR.
     * The following key codes are for MTK IR . */
    public static final int KEYCODE_MTKIR_POWER        = 301;
    public static final int KEYCODE_MTKIR_ROOTMENU     = 302;
    public static final int KEYCODE_MTKIR_SOURCE       = 303;
    public static final int KEYCODE_MTKIR_TIMER        = 304;
    public static final int KEYCODE_MTKIR_SLEEP        = 305;
    public static final int KEYCODE_MTKIR_ZOOM         = 306;
    public static final int KEYCODE_MTKIR_PEFFECT      = 307;
    public static final int KEYCODE_MTKIR_SEFFECT      = 308;
    public static final int KEYCODE_MTKIR_ASPECT       = 309;
    public static final int KEYCODE_MTKIR_PIPPOP       = 310;
    public static final int KEYCODE_MTKIR_POPPOS       = 311;
    public static final int KEYCODE_MTKIR_PIPSIZE      = 312;
    public static final int KEYCODE_MTKIR_MTSAUDIO     = 313;
    public static final int KEYCODE_MTKIR_CC           = 314;
    public static final int KEYCODE_MTKIR_SWAP         = 315;
    public static final int KEYCODE_MTKIR_1            = 316;
    public static final int KEYCODE_MTKIR_2            = 317;
    public static final int KEYCODE_MTKIR_3            = 318;
    public static final int KEYCODE_MTKIR_4            = 319;
    public static final int KEYCODE_MTKIR_5            = 320;
    public static final int KEYCODE_MTKIR_6            = 321;
    public static final int KEYCODE_MTKIR_7            = 322;
    public static final int KEYCODE_MTKIR_8            = 323;
    public static final int KEYCODE_MTKIR_9            = 324;
    public static final int KEYCODE_MTKIR_FREEZE       = 325;
    public static final int KEYCODE_MTKIR_0            = 326;
    public static final int KEYCODE_MTKIR_DOT          = 327;
    public static final int KEYCODE_MTKIR_CHUP         = 328;
    public static final int KEYCODE_MTKIR_PRECH        = 329;
    public static final int KEYCODE_MTKIR_VOLUP        = 330;
    public static final int KEYCODE_MTKIR_CHDN         = 331;
    public static final int KEYCODE_MTKIR_MUTE         = 164;
    public static final int KEYCODE_MTKIR_VOLDN        = 333;
    public static final int KEYCODE_MTKIR_MENU         = 334;
    public static final int KEYCODE_MTKIR_UP           = 335;
    public static final int KEYCODE_MTKIR_INFO         = 336;
    public static final int KEYCODE_MTKIR_LEFT         = 337;
    public static final int KEYCODE_MTKIR_ENTER        = 338;
    public static final int KEYCODE_MTKIR_RIGHT        = 339;
    public static final int KEYCODE_MTKIR_GUIDE        = 340;
    public static final int KEYCODE_MTKIR_DOWN         = 341;
    public static final int KEYCODE_MTKIR_EXIT         = 342;
    public static final int KEYCODE_MTKIR_EJECT        = 129;
    public static final int KEYCODE_MTKIR_PLAYPAUSE    = 344;
    public static final int KEYCODE_MTKIR_STOP         = 345;
    public static final int KEYCODE_MTKIR_RECORD       = 130;
    public static final int KEYCODE_MTKIR_REWIND       = 347;
    public static final int KEYCODE_MTKIR_FASTFORWARD  = 348;
    public static final int KEYCODE_MTKIR_PREVIOUS     = 349;
    public static final int KEYCODE_MTKIR_NEXT         = 350;
    public static final int KEYCODE_MTKIR_TITLEPBC     = 351;
    public static final int KEYCODE_MTKIR_SUBTITLE     = 352;
    public static final int KEYCODE_MTKIR_REPEAT       = 353;
    public static final int KEYCODE_MTKIR_ANGLE        = 354;
    public static final int KEYCODE_MTKIR_RED          = 355;
    public static final int KEYCODE_MTKIR_GREEN        = 356;
    public static final int KEYCODE_MTKIR_YELLOW       = 357;
    public static final int KEYCODE_MTKIR_BLUE         = 358;
    public static final int KEYCODE_MTKIR_TTX          = 359;
    public static final int KEYCODE_MTKIR_POP          = 360;
    public static final int KEYCODE_MTKIR_TV           = 361;
    public static final int KEYCODE_MTKIR_TV_ANA       = 362;
    public static final int KEYCODE_MTKIR_TV_DIG       = 363;
    public static final int KEYCODE_MTKIR_WIDGET       = 364;
    public static final int KEYCODE_MTKIR_INDEX        = 365;
    public static final int KEYCODE_MTKIR_TOOLS        = 366;
    public static final int KEYCODE_MTKIR_NETFLIX      = 367;
    public static final int KEYCODE_MTKIR_BACKUP_0     = 368;
    public static final int KEYCODE_MTKIR_SURROUND     = 369;
    public static final int KEYCODE_MTKIR_POWER_ON     = 370;
    public static final int KEYCODE_MTKIR_POWER_OFF    = 371;
    public static final int KEYCODE_MTKIR_COMPONENT_1  = 372;
    public static final int KEYCODE_MTKIR_COMPONENT_2  = 373;
    public static final int KEYCODE_MTKIR_PLAY         = 374;
    public static final int KEYCODE_MTKIR_PAUSE        = 375;
    public static final int KEYCODE_MTKIR_POWER_SAVING = 376;
    public static final int KEYCODE_MTKIR_3D           = 377;
    public static final int KEYCODE_MTKIR_FUNCTION_1   = 378;
    public static final int KEYCODE_MTKIR_FUNCTION_2   = 379;
    public static final int KEYCODE_MTKIR_FUNCTION_3   = 380;
    public static final int KEYCODE_MTKIR_FUNCTION_4   = 381;
    public static final int KEYCODE_MTKIR_FUNCTION_5   = 382;
    public static final int KEYCODE_MTKIR_BACKUP_1     = 383;
    public static final int KEYCODE_MTKIR_BACKUP_2     = 384;
    public static final int KEYCODE_MTKIR_BACKUP_3     = 385;
    public static final int KEYCODE_MTKIR_BACKUP_4     = 386;
    public static final int KEYCODE_MTKIR_BACKUP_5     = 387;
    public static final int KEYCODE_MTKIR_BACKUP_6     = 388;
    public static final int KEYCODE_MTKIR_BACKUP_7     = 389;
    public static final int KEYCODE_MTKIR_BACKUP_8     = 390;
    public static final int KEYCODE_MTKIR_BACKUP_9     = 391;
    public static final int KEYCODE_MTKIR_BACKUP_10    = 392;
    public static final int KEYCODE_MTKIR_BACKUP_11    = 393;
    public static final int KEYCODE_MTKIR_BACKUP_12    = 394;
    public static final int KEYCODE_MTKIR_BACKUP_13    = 395;
    public static final int KEYCODE_MTKIR_BACKUP_14    = 396;
    public static final int KEYCODE_MTKIR_BACKUP_15    = 397;
    public static final int KEYCODE_MTKIR_BACKUP_16    = 398;
    public static final int KEYCODE_MTKIR_BACKUP_17    = 399;
    public static final int KEYCODE_MTKIR_CUSTOM_1     = 400;
    public static final int KEYCODE_MTKIR_CUSTOM_2     = 401;
    public static final int KEYCODE_MTKIR_CUSTOM_3     = 402;
    public static final int KEYCODE_MTKIR_CUSTOM_4     = 403;
    public static final int KEYCODE_MTKIR_CUSTOM_5     = 404;
    public static final int KEYCODE_MTKIR_CUSTOM_6     = 405;
    public static final int KEYCODE_MTKIR_CUSTOM_7     = 406;
    public static final int KEYCODE_MTKIR_CUSTOM_8     = 407;
    public static final int KEYCODE_MTKIR_CUSTOM_9     = 408;
    public static final int KEYCODE_MTKIR_CUSTOM_10    = 409;
    public static final int KEYCODE_MTKIR_CUSTOM_11    = 410;
    public static final int KEYCODE_MTKIR_CUSTOM_12    = 411;
    public static final int KEYCODE_MTKIR_CUSTOM_13    = 412;
    public static final int KEYCODE_MTKIR_CUSTOM_14    = 413;
    public static final int KEYCODE_MTKIR_CUSTOM_15    = 414;
    public static final int KEYCODE_MTKIR_CUSTOM_16    = 415;
    public static final int KEYCODE_MTKIR_CUSTOM_17    = 416;
    public static final int KEYCODE_MTKIR_CUSTOM_18    = 417;
    public static final int KEYCODE_MTKIR_CUSTOM_19    = 418;
    public static final int KEYCODE_MTKIR_CUSTOM_20    = 419;
    public static final int KEYCODE_MTKIR_CUSTOM_21    = 420;
    public static final int KEYCODE_MTKIR_CUSTOM_22    = 421;
    public static final int KEYCODE_MTKIR_CUSTOM_23    = 422;
    public static final int KEYCODE_MTKIR_CUSTOM_24    = 423;
    public static final int KEYCODE_MTKIR_CUSTOM_25    = 424;
    public static final int KEYCODE_MTKIR_CUSTOM_26    = 425;
    public static final int KEYCODE_MTKIR_CUSTOM_27    = 426;
    public static final int KEYCODE_MTKIR_CUSTOM_28    = 427;
    public static final int KEYCODE_MTKIR_CUSTOM_29    = 428;
    public static final int KEYCODE_MTKIR_CUSTOM_30    = 429;
    public static final int KEYCODE_MTKIR_CUSTOM_31    = 430;
    public static final int KEYCODE_MTKIR_CUSTOM_32    = 431;
    public static final int KEYCODE_MTKIR_CUSTOM_33    = 432;
    public static final int KEYCODE_MTKIR_CUSTOM_34    = 433;
    public static final int KEYCODE_MTKIR_CUSTOM_35    = 434;
    public static final int KEYCODE_MTKIR_CUSTOM_36    = 435;
    public static final int KEYCODE_MTKIR_CUSTOM_37    = 436;
    public static final int KEYCODE_MTKIR_CUSTOM_38    = 437;
    public static final int KEYCODE_MTKIR_CUSTOM_39    = 438;
    public static final int KEYCODE_MTKIR_CUSTOM_40    = 439;
    public static final int KEYCODE_MTKIR_CUSTOM_41    = 440;
    public static final int KEYCODE_MTKIR_CUSTOM_42    = 441;
    public static final int KEYCODE_MTKIR_CUSTOM_43    = 442;
    public static final int KEYCODE_MTKIR_CUSTOM_44    = 443;
    public static final int KEYCODE_MTKIR_CUSTOM_45    = 444;
    public static final int KEYCODE_MTKIR_CUSTOM_46    = 445;
    public static final int KEYCODE_MTKIR_CUSTOM_47    = 446;
    public static final int KEYCODE_MTKIR_CUSTOM_48    = 447;
    public static final int KEYCODE_MTKIR_CUSTOM_49    = 448;
    public static final int KEYCODE_MTKIR_CUSTOM_50    = 449;
    public static final int KEYCODE_MTKIR_CUSTOM_51    = 450;
    public static final int KEYCODE_MTKIR_CUSTOM_52    = 451;
    public static final int KEYCODE_MTKIR_CUSTOM_53    = 452;
    public static final int KEYCODE_MTKIR_CUSTOM_54    = 453;
    public static final int KEYCODE_MTKIR_CUSTOM_55    = 454;
    public static final int KEYCODE_MTKIR_CUSTOM_56    = 455;
    public static final int KEYCODE_MTKIR_CUSTOM_57    = 456;
    public static final int KEYCODE_MTKIR_CUSTOM_58    = 457;
    public static final int KEYCODE_MTKIR_CUSTOM_59    = 458;
    public static final int KEYCODE_MTKIR_CUSTOM_60    = 459;
    public static final int KEYCODE_MTKIR_CUSTOM_61    = 460;
    public static final int KEYCODE_MTKIR_CUSTOM_62    = 461;
    public static final int KEYCODE_MTKIR_CUSTOM_63    = 462;
    public static final int KEYCODE_MTKIR_CUSTOM_64    = 463;
    public static final int KEYCODE_MTKIR_CUSTOM_65    = 464;
    public static final int KEYCODE_MTKIR_CUSTOM_66    = 465;
    public static final int KEYCODE_MTKIR_CUSTOM_67    = 466;
    public static final int KEYCODE_MTKIR_CUSTOM_68    = 467;
    public static final int KEYCODE_MTKIR_CUSTOM_69    = 468;
    public static final int KEYCODE_MTKIR_CUSTOM_70    = 469;
    public static final int KEYCODE_MTKIR_CUSTOM_71    = 470;
    public static final int KEYCODE_MTKIR_CUSTOM_72    = 471;
    public static final int KEYCODE_MTKIR_CUSTOM_73    = 472;
    public static final int KEYCODE_MTKIR_CUSTOM_74    = 473;
    public static final int KEYCODE_MTKIR_CUSTOM_75    = 474;
    public static final int KEYCODE_MTKIR_CUSTOM_76    = 475;
    public static final int KEYCODE_MTKIR_CUSTOM_77    = 476;
    public static final int KEYCODE_MTKIR_CUSTOM_78    = 477;
    public static final int KEYCODE_MTKIR_CUSTOM_79    = 478;
    public static final int KEYCODE_MTKIR_CUSTOM_80    = 479;
    public static final int KEYCODE_MTKIR_CUSTOM_81    = 480;
    public static final int KEYCODE_MTKIR_CUSTOM_82    = 481;
    public static final int KEYCODE_MTKIR_CUSTOM_83    = 482;
    public static final int KEYCODE_MTKIR_CUSTOM_84    = 483;
    public static final int KEYCODE_MTKIR_CUSTOM_85    = 484;
    public static final int KEYCODE_MTKIR_CUSTOM_86    = 485;
    public static final int KEYCODE_MTKIR_CUSTOM_87    = 486;
    public static final int KEYCODE_MTKIR_CUSTOM_88    = 487;
    public static final int KEYCODE_MTKIR_CUSTOM_89    = 488;
    public static final int KEYCODE_MTKIR_CUSTOM_90    = 489;
    public static final int KEYCODE_MTKIR_CUSTOM_91    = 490;
    public static final int KEYCODE_MTKIR_CUSTOM_92    = 491;
    public static final int KEYCODE_MTKIR_CUSTOM_93    = 492;
    public static final int KEYCODE_MTKIR_CUSTOM_94    = 493;
    public static final int KEYCODE_MTKIR_CUSTOM_95    = 494;
    public static final int KEYCODE_MTKIR_CUSTOM_96    = 495;
    public static final int KEYCODE_MTKIR_CUSTOM_97    = 496;
    public static final int KEYCODE_MTKIR_CUSTOM_98    = 497;
    public static final int KEYCODE_MTKIR_CUSTOM_99    = 498;
    public static final int KEYCODE_MTKIR_CUSTOM_100   = 499;

	// TCL section, range 801-4100   naming rule: KEYCODE_TCL_XXX
	...
	public static final int KEYCODE_5IN1_LEFT = 821; 
	public static final int KEYCODE_5IN1_RIGHT = 822; 
	public static final int KEYCODE_5IN1_UP = 823; 
	public static final int KEYCODE_5IN1_DOWN = 824; 
	public static final int KEYCODE_5IN1_ENTER = 825;
	public static final int KEYCODE_5IN1_MENU = 826;		//qiyx add for 7 keys pad 150228
	public static final int KEYCODE_5IN1_POWER = 827;		
    ...
    public static final int KEYCODE_TCL_CIRCLE_CTR_CLOCKWISE            = 4009;
    ...
    public static final int KEYCODE_TCL_START_MOUSE                     = 4021;
    public static final int KEYCODE_TCL_MOUSE_BSB_LEFT                  = 4022;
    public static final int KEYCODE_TCL_MOUSE_BSB_RIGHT                 = 4023;
    public static final int KEYCODE_TCL_FOCUS_BSB_LEFT                  = 4024;
    public static final int KEYCODE_TCL_FOCUS_BSB_RIGHT                 = 4025;
   	
    public static final int KEYCODE_TCL_TOUCH_BEEN_MAX                  = 4030;
    public static final int KEYCODE_TCL_TOUCH_BEEN_MIN                  = 4031;
    public static final int KEYCODE_TCL_TOUCH_ROTATE_LEFT               = 4032;
    public static final int KEYCODE_TCL_TOUCH_ROTATE_RIGHT              = 4033;
	
    public static final int KEYCODE_TCL_JOYSTICK_R_AXIS_UP              = 4041;
    public static final int KEYCODE_TCL_JOYSTICK_R_AXIS_DOWN            = 4042;
    public static final int KEYCODE_TCL_JOYSTICK_R_AXIS_LEFT            = 4043;
    public static final int KEYCODE_TCL_JOYSTICK_R_AXIS_RIGHT           = 4044;
    public static final int KEYCODE_TCL_SHARE                           = 4045;
    public static final int KEYCODE_TCL_POUND                           = 4046;
    public static final int KEYCODE_TCL_MOUSE_IDLE_FADE                 = 4047;
    public static final int KEYCODE_TCL_RC_RF_UNCONNECT					= 4048;
    public static final int KEYCODE_TCL_ARK                             = 4049;
    public static final int KEYCODE_TCL_DISNEY_GAME                     = 4050;
    public static final int KEYCODE_TCL_DISNEY_SHOP                     = 4051;
    public static final int KEYCODE_TCL_RF_LINK_S                       = 4052;
    public static final int KEYCODE_TCL_RF_LINK_F                       = 4053;
    public static final int KEYCODE_TCL_UNKNOWN_KEY_REPORT              = 4054;
    public static final int KEYCODE_TCL_HISTORY                         = 4055;
    public static final int KEYCODE_TCL_NUMBER                          = 4056;
	public static final int KEYCODE_TCL_USB_MEDIA                       = 4057;
	public static final int KEYCODE_TCL_UD_DG_S                         = 4058;
	public static final int KEYCODE_TCL_UD_DG_F                         = 4059;
	public static final int KEYCODE_TCL_UD_DG_B                         = 4060;
	public static final int KEYCODE_TCL_FORCE_AMAZON                    = 4061;
	public static final int KEYCODE_TCL_FORCE_NETFLIX                   = 4062;
	public static final int KEYCODE_TCL_FORCE_VUDU                      = 4063;
	public static final int KEYCODE_TCL_FORCE_MGO                       = 4064;
	public static final int KEYCODE_TCL_FORCE_YOUTUBE                   = 4065;
	public static final int KEYCODE_TCL_FORCE_HULU                      = 4066;
	public static final int KEYCODE_TCL_PIP                             = 4067;
	public static final int KEYCODE_TCL_FORCE_SEARCH                    = 4068;
	public static final int KEYCODE_TCL_FORCE_PRIMETIME                 = 4069;
	public static final int KEYCODE_TCL_NETFLIX_FORWARD                 = 4070;
	public static final int KEYCODE_TCL_NETFLIX_PLAYPAUSE               = 4071;
	public static final int KEYCODE_TCL_NETFLIX_NEXT                    = 4072;
	public static final int KEYCODE_TCL_NETFLIX_FF                      = 4073;
	public static final int KEYCODE_TCL_NETFLIX_STOP                    = 4074;
	public static final int KEYCODE_TCL_NETFLIX_FB                      = 4075;
    public static final int KEYCODE_TCL_RC_SLEEP                        = 4076;
    public static final int KEYCODE_TCL_SET                             = 4077;
    public static final int KEYCODE_TCL_NFC_EA                          = 4078;
	public static final int KEYCODE_TCL_SEARCH                          = 4079;
    public static final int KEYCODE_TCL_COLLECT                         = 4080;
    public static final int KEYCODE_TCL_LAST                            = 4081;
    public static final int KEYCODE_TCL_ALL_APP                         = 4082;	
	public static final int KEYCODE_TCL_MORE                            = 4083;
	public static final int KEYCODE_TCL_LANG                            = 4084;
	public static final int KEYCODE_TCL_SUBTITLE                        = 4085;
	public static final int KEYCODE_TCL_TEXT                            = 4086;
	public static final int KEYCODE_TCL_MIRACAST                        = 4087;
	public static final int KEYCODE_TCL_VOICE                           = 4088;
	public static final int KEYCODE_TCL_ROLE                            = 4089;
	public static final int KEYCODE_TCL_LIST                            = 4090;
	public static final int KEYCODE_TCL_DOT                             = 4091;
	public static final int KEYCODE_TCL_MIC                             = 4092;
	public static final int KEYCODE_TCL_SENSOR_WAKEUP                   = 4097;//just use send virtaul key for sensor wakeup 
	public static final int KEYCODE_TCL_LOW_VOLTAGE                     = 4098;
	public static final int KEYCODE_TCL_RF_LINK_EXCEPTION               = 4099;
	public static final int KEYCODE_TCL_MEDIA_FAST_REVERSE              = 4100;
    private static final int LAST_KEYCODE								= KEYCODE_TCL_MEDIA_FAST_REVERSE;
    ...
    private static void populateKeycodeSymbolicNames() {
        ...
        names.append(KEYCODE_MTKIR_POWER, "KEYCODE_MTKIR_POWER");
        names.append(KEYCODE_MTKIR_ROOTMENU, "KEYCODE_MTKIR_ROOTMENU");
        names.append(KEYCODE_MTKIR_SOURCE, "KEYCODE_MTKIR_SOURCE");
        names.append(KEYCODE_MTKIR_TIMER, "KEYCODE_MTKIR_TIMER");
        names.append(KEYCODE_MTKIR_SLEEP, "KEYCODE_MTKIR_SLEEP");
        names.append(KEYCODE_MTKIR_ZOOM, "KEYCODE_MTKIR_ZOOM");
        names.append(KEYCODE_MTKIR_PEFFECT, "KEYCODE_MTKIR_PEFFECT");
        names.append(KEYCODE_MTKIR_SEFFECT, "KEYCODE_MTKIR_SEFFECT");
        names.append(KEYCODE_MTKIR_ASPECT, "KEYCODE_MTKIR_ASPECT");
        names.append(KEYCODE_MTKIR_PIPPOP, "KEYCODE_MTKIR_PIPPOP");
        names.append(KEYCODE_MTKIR_POPPOS, "KEYCODE_MTKIR_POPPOS");
        names.append(KEYCODE_MTKIR_PIPSIZE, "KEYCODE_MTKIR_PIPSIZE");
        names.append(KEYCODE_MTKIR_MTSAUDIO, "KEYCODE_MTKIR_MTSAUDIO");
        names.append(KEYCODE_MTKIR_CC, "KEYCODE_MTKIR_CC");
        names.append(KEYCODE_MTKIR_SWAP, "KEYCODE_MTKIR_SWAP");
        names.append(KEYCODE_MTKIR_1, "KEYCODE_MTKIR_1");
        names.append(KEYCODE_MTKIR_2, "KEYCODE_MTKIR_2");
        names.append(KEYCODE_MTKIR_3, "KEYCODE_MTKIR_3");
        names.append(KEYCODE_MTKIR_4, "KEYCODE_MTKIR_4");
        names.append(KEYCODE_MTKIR_5, "KEYCODE_MTKIR_5");
        names.append(KEYCODE_MTKIR_6, "KEYCODE_MTKIR_6");
        names.append(KEYCODE_MTKIR_7, "KEYCODE_MTKIR_7");
        names.append(KEYCODE_MTKIR_8, "KEYCODE_MTKIR_8");
        names.append(KEYCODE_MTKIR_9, "KEYCODE_MTKIR_9");    
        names.append(KEYCODE_MTKIR_FREEZE, "KEYCODE_MTKIR_FREEZE");
        names.append(KEYCODE_MTKIR_0, "KEYCODE_MTKIR_0");
        names.append(KEYCODE_MTKIR_DOT, "KEYCODE_MTKIR_DOT");
        names.append(KEYCODE_MTKIR_CHUP, "KEYCODE_MTKIR_CHUP");
        names.append(KEYCODE_MTKIR_PRECH, "KEYCODE_MTKIR_PRECH");
        names.append(KEYCODE_MTKIR_VOLUP, "KEYCODE_MTKIR_VOLUP");
        names.append(KEYCODE_MTKIR_CHDN, "KEYCODE_MTKIR_CHDN");
        names.append(KEYCODE_MTKIR_MUTE, "KEYCODE_MTKIR_MUTE");
        names.append(KEYCODE_MTKIR_VOLDN, "KEYCODE_MTKIR_VOLDN");
        names.append(KEYCODE_MTKIR_MENU, "KEYCODE_MTKIR_MENU");
        names.append(KEYCODE_MTKIR_UP, "KEYCODE_MTKIR_UP");
        names.append(KEYCODE_MTKIR_INFO, "KEYCODE_MTKIR_INFO");
        names.append(KEYCODE_MTKIR_LEFT, "KEYCODE_MTKIR_LEFT");
        names.append(KEYCODE_MTKIR_ENTER, "KEYCODE_MTKIR_ENTER");
        names.append(KEYCODE_MTKIR_RIGHT, "KEYCODE_MTKIR_RIGHT");
        names.append(KEYCODE_MTKIR_GUIDE, "KEYCODE_MTKIR_GUIDE");
        names.append(KEYCODE_MTKIR_DOWN, "KEYCODE_MTKIR_GUIDE");
        names.append(KEYCODE_MTKIR_EXIT, "KEYCODE_MTKIR_EXIT");
        names.append(KEYCODE_MTKIR_EJECT, "KEYCODE_MTKIR_EJECT");
        names.append(KEYCODE_MTKIR_PLAYPAUSE, "KEYCODE_MTKIR_PLAYPAUSE");
        names.append(KEYCODE_MTKIR_STOP, "KEYCODE_MTKIR_STOP");
        names.append(KEYCODE_MTKIR_RECORD, "KEYCODE_MTKIR_RECORD");
        names.append(KEYCODE_MTKIR_REWIND, "KEYCODE_MTKIR_REWIND");
        names.append(KEYCODE_MTKIR_FASTFORWARD, "KEYCODE_MTKIR_FASTFORWARD");
        names.append(KEYCODE_MTKIR_PREVIOUS, "KEYCODE_MTKIR_PREVIOUS");
        names.append(KEYCODE_MTKIR_NEXT, "KEYCODE_MTKIR_NEXT");
        names.append(KEYCODE_MTKIR_TITLEPBC, "KEYCODE_MTKIR_TITLEPBC");
        names.append(KEYCODE_MTKIR_SUBTITLE, "KEYCODE_MTKIR_SUBTITLE");
        names.append(KEYCODE_MTKIR_REPEAT, "KEYCODE_MTKIR_REPEAT");
        names.append(KEYCODE_MTKIR_ANGLE, "KEYCODE_MTKIR_ANGLE");
        names.append(KEYCODE_MTKIR_RED, "KEYCODE_MTKIR_RED");
        names.append(KEYCODE_MTKIR_GREEN, "KEYCODE_MTKIR_GREEN");
        names.append(KEYCODE_MTKIR_YELLOW, "KEYCODE_MTKIR_YELLOW");
        names.append(KEYCODE_MTKIR_BLUE, "KEYCODE_MTKIR_BLUE");
        names.append(KEYCODE_MTKIR_TTX, "KEYCODE_MTKIR_TTX");
        names.append(KEYCODE_MTKIR_POP, "KEYCODE_MTKIR_POP");
        names.append(KEYCODE_MTKIR_TV, "KEYCODE_MTKIR_TV");
        names.append(KEYCODE_MTKIR_TV_ANA, "KEYCODE_MTKIR_TV_ANA");
        names.append(KEYCODE_MTKIR_TV_DIG, "KEYCODE_MTKIR_TV_DIG");
        names.append(KEYCODE_MTKIR_WIDGET, "KEYCODE_MTKIR_WIDGET");
        names.append(KEYCODE_MTKIR_INDEX, "KEYCODE_MTKIR_INDEX");
        names.append(KEYCODE_MTKIR_TOOLS, "KEYCODE_MTKIR_TOOLS");
        names.append(KEYCODE_MTKIR_NETFLIX, "KEYCODE_MTKIR_NETFLIX");
        names.append(KEYCODE_MTKIR_BACKUP_0, "KEYCODE_MTKIR_BACKUP_0");
        names.append(KEYCODE_MTKIR_SURROUND, "KEYCODE_MTKIR_SURROUND");
        names.append(KEYCODE_MTKIR_POWER_ON, "KEYCODE_MTKIR_POWER_ON");
        names.append(KEYCODE_MTKIR_POWER_OFF, "KEYCODE_MTKIR_POWER_OFF");
        names.append(KEYCODE_MTKIR_COMPONENT_1, "KEYCODE_MTKIR_COMPONENT_1");
        names.append(KEYCODE_MTKIR_COMPONENT_2, "KEYCODE_MTKIR_COMPONENT_2");
        names.append(KEYCODE_MTKIR_PLAY, "KEYCODE_MTKIR_PLAY");
        names.append(KEYCODE_MTKIR_PAUSE, "KEYCODE_MTKIR_PAUSE");
        names.append(KEYCODE_MTKIR_POWER_SAVING, "KEYCODE_MTKIR_POWER_SAVING");
        names.append(KEYCODE_MTKIR_3D, "KEYCODE_MTKIR_3D");
        names.append(KEYCODE_MTKIR_FUNCTION_1, "KEYCODE_MTKIR_FUNCTION_1");
        names.append(KEYCODE_MTKIR_FUNCTION_2, "KEYCODE_MTKIR_FUNCTION_2");
        names.append(KEYCODE_MTKIR_FUNCTION_3, "KEYCODE_MTKIR_FUNCTION_3");
        names.append(KEYCODE_MTKIR_FUNCTION_4, "KEYCODE_MTKIR_FUNCTION_4");
        names.append(KEYCODE_MTKIR_FUNCTION_5, "KEYCODE_MTKIR_FUNCTION_5");
        names.append(KEYCODE_MTKIR_BACKUP_1, "KEYCODE_MTKIR_BACKUP_1");
        names.append(KEYCODE_MTKIR_BACKUP_2, "KEYCODE_MTKIR_BACKUP_2");
        names.append(KEYCODE_MTKIR_BACKUP_3, "KEYCODE_MTKIR_BACKUP_3");
        names.append(KEYCODE_MTKIR_BACKUP_4, "KEYCODE_MTKIR_BACKUP_4");
        names.append(KEYCODE_MTKIR_BACKUP_5, "KEYCODE_MTKIR_BACKUP_5");
        names.append(KEYCODE_MTKIR_BACKUP_6, "KEYCODE_MTKIR_BACKUP_6");
        names.append(KEYCODE_MTKIR_BACKUP_7, "KEYCODE_MTKIR_BACKUP_7");
        names.append(KEYCODE_MTKIR_BACKUP_8, "KEYCODE_MTKIR_BACKUP_8");
        names.append(KEYCODE_MTKIR_BACKUP_9, "KEYCODE_MTKIR_BACKUP_9");
        names.append(KEYCODE_MTKIR_BACKUP_10, "KEYCODE_MTKIR_BACKUP_10");
        names.append(KEYCODE_MTKIR_BACKUP_11, "KEYCODE_MTKIR_BACKUP_11");
        names.append(KEYCODE_MTKIR_BACKUP_12, "KEYCODE_MTKIR_BACKUP_12");
        names.append(KEYCODE_MTKIR_BACKUP_13, "KEYCODE_MTKIR_BACKUP_13");
        names.append(KEYCODE_MTKIR_BACKUP_14, "KEYCODE_MTKIR_BACKUP_14");
        names.append(KEYCODE_MTKIR_BACKUP_15, "KEYCODE_MTKIR_BACKUP_15");
        names.append(KEYCODE_MTKIR_BACKUP_16, "KEYCODE_MTKIR_BACKUP_16");
        names.append(KEYCODE_MTKIR_BACKUP_17, "KEYCODE_MTKIR_BACKUP_17");
        names.append(KEYCODE_MTKIR_CUSTOM_1, "KEYCODE_MTKIR_CUSTOM_1");
        names.append(KEYCODE_MTKIR_CUSTOM_2, "KEYCODE_MTKIR_CUSTOM_2");
        names.append(KEYCODE_MTKIR_CUSTOM_3, "KEYCODE_MTKIR_CUSTOM_3");
        names.append(KEYCODE_MTKIR_CUSTOM_4, "KEYCODE_MTKIR_CUSTOM_4");
        names.append(KEYCODE_MTKIR_CUSTOM_5, "KEYCODE_MTKIR_CUSTOM_5");
        names.append(KEYCODE_MTKIR_CUSTOM_6, "KEYCODE_MTKIR_CUSTOM_6");
        names.append(KEYCODE_MTKIR_CUSTOM_7, "KEYCODE_MTKIR_CUSTOM_7");
        names.append(KEYCODE_MTKIR_CUSTOM_8, "KEYCODE_MTKIR_CUSTOM_8");
        names.append(KEYCODE_MTKIR_CUSTOM_9, "KEYCODE_MTKIR_CUSTOM_9");
        names.append(KEYCODE_MTKIR_CUSTOM_10, "KEYCODE_MTKIR_CUSTOM_10");
        names.append(KEYCODE_MTKIR_CUSTOM_11, "KEYCODE_MTKIR_CUSTOM_11");
        names.append(KEYCODE_MTKIR_CUSTOM_12, "KEYCODE_MTKIR_CUSTOM_12");
        names.append(KEYCODE_MTKIR_CUSTOM_13, "KEYCODE_MTKIR_CUSTOM_13");
        names.append(KEYCODE_MTKIR_CUSTOM_14, "KEYCODE_MTKIR_CUSTOM_14");
        names.append(KEYCODE_MTKIR_CUSTOM_15, "KEYCODE_MTKIR_CUSTOM_15");
        names.append(KEYCODE_MTKIR_CUSTOM_16, "KEYCODE_MTKIR_CUSTOM_16");
        names.append(KEYCODE_MTKIR_CUSTOM_17, "KEYCODE_MTKIR_CUSTOM_17");
        names.append(KEYCODE_MTKIR_CUSTOM_18, "KEYCODE_MTKIR_CUSTOM_18");
        names.append(KEYCODE_MTKIR_CUSTOM_19, "KEYCODE_MTKIR_CUSTOM_19");
        names.append(KEYCODE_MTKIR_CUSTOM_20, "KEYCODE_MTKIR_CUSTOM_20");
        names.append(KEYCODE_MTKIR_CUSTOM_21, "KEYCODE_MTKIR_CUSTOM_21");
        names.append(KEYCODE_MTKIR_CUSTOM_22, "KEYCODE_MTKIR_CUSTOM_22");
        names.append(KEYCODE_MTKIR_CUSTOM_23, "KEYCODE_MTKIR_CUSTOM_23");
        names.append(KEYCODE_MTKIR_CUSTOM_24, "KEYCODE_MTKIR_CUSTOM_24");
        names.append(KEYCODE_MTKIR_CUSTOM_25, "KEYCODE_MTKIR_CUSTOM_25");
        names.append(KEYCODE_MTKIR_CUSTOM_26, "KEYCODE_MTKIR_CUSTOM_26");
        names.append(KEYCODE_MTKIR_CUSTOM_27, "KEYCODE_MTKIR_CUSTOM_27");
        names.append(KEYCODE_MTKIR_CUSTOM_28, "KEYCODE_MTKIR_CUSTOM_28");
        names.append(KEYCODE_MTKIR_CUSTOM_29, "KEYCODE_MTKIR_CUSTOM_29");
        names.append(KEYCODE_MTKIR_CUSTOM_30, "KEYCODE_MTKIR_CUSTOM_30");
        names.append(KEYCODE_MTKIR_CUSTOM_31, "KEYCODE_MTKIR_CUSTOM_31");
        names.append(KEYCODE_MTKIR_CUSTOM_32, "KEYCODE_MTKIR_CUSTOM_32");
        names.append(KEYCODE_MTKIR_CUSTOM_33, "KEYCODE_MTKIR_CUSTOM_33");
        names.append(KEYCODE_MTKIR_CUSTOM_34, "KEYCODE_MTKIR_CUSTOM_34");
        names.append(KEYCODE_MTKIR_CUSTOM_35, "KEYCODE_MTKIR_CUSTOM_35");
        names.append(KEYCODE_MTKIR_CUSTOM_36, "KEYCODE_MTKIR_CUSTOM_36");
        names.append(KEYCODE_MTKIR_CUSTOM_37, "KEYCODE_MTKIR_CUSTOM_37");
        names.append(KEYCODE_MTKIR_CUSTOM_38, "KEYCODE_MTKIR_CUSTOM_38");
        names.append(KEYCODE_MTKIR_CUSTOM_39, "KEYCODE_MTKIR_CUSTOM_39");
        names.append(KEYCODE_MTKIR_CUSTOM_40, "KEYCODE_MTKIR_CUSTOM_40");
        names.append(KEYCODE_MTKIR_CUSTOM_41, "KEYCODE_MTKIR_CUSTOM_41");
        names.append(KEYCODE_MTKIR_CUSTOM_42, "KEYCODE_MTKIR_CUSTOM_42");
        names.append(KEYCODE_MTKIR_CUSTOM_43, "KEYCODE_MTKIR_CUSTOM_43");
        names.append(KEYCODE_MTKIR_CUSTOM_44, "KEYCODE_MTKIR_CUSTOM_44");
        names.append(KEYCODE_MTKIR_CUSTOM_45, "KEYCODE_MTKIR_CUSTOM_45");
        names.append(KEYCODE_MTKIR_CUSTOM_46, "KEYCODE_MTKIR_CUSTOM_46");
        names.append(KEYCODE_MTKIR_CUSTOM_47, "KEYCODE_MTKIR_CUSTOM_47");
        names.append(KEYCODE_MTKIR_CUSTOM_48, "KEYCODE_MTKIR_CUSTOM_48");
        names.append(KEYCODE_MTKIR_CUSTOM_49, "KEYCODE_MTKIR_CUSTOM_49");
        names.append(KEYCODE_MTKIR_CUSTOM_50, "KEYCODE_MTKIR_CUSTOM_50");
        names.append(KEYCODE_MTKIR_CUSTOM_51, "KEYCODE_MTKIR_CUSTOM_51");
        names.append(KEYCODE_MTKIR_CUSTOM_52, "KEYCODE_MTKIR_CUSTOM_52");
        names.append(KEYCODE_MTKIR_CUSTOM_53, "KEYCODE_MTKIR_CUSTOM_53");
        names.append(KEYCODE_MTKIR_CUSTOM_54, "KEYCODE_MTKIR_CUSTOM_54");
        names.append(KEYCODE_MTKIR_CUSTOM_55, "KEYCODE_MTKIR_CUSTOM_55");
        names.append(KEYCODE_MTKIR_CUSTOM_56, "KEYCODE_MTKIR_CUSTOM_56");
        names.append(KEYCODE_MTKIR_CUSTOM_57, "KEYCODE_MTKIR_CUSTOM_57");
        names.append(KEYCODE_MTKIR_CUSTOM_58, "KEYCODE_MTKIR_CUSTOM_58");
        names.append(KEYCODE_MTKIR_CUSTOM_59, "KEYCODE_MTKIR_CUSTOM_59");
        names.append(KEYCODE_MTKIR_CUSTOM_60, "KEYCODE_MTKIR_CUSTOM_60");
        names.append(KEYCODE_MTKIR_CUSTOM_61, "KEYCODE_MTKIR_CUSTOM_61");
        names.append(KEYCODE_MTKIR_CUSTOM_62, "KEYCODE_MTKIR_CUSTOM_62");
        names.append(KEYCODE_MTKIR_CUSTOM_63, "KEYCODE_MTKIR_CUSTOM_63");
        names.append(KEYCODE_MTKIR_CUSTOM_64, "KEYCODE_MTKIR_CUSTOM_64");
        names.append(KEYCODE_MTKIR_CUSTOM_65, "KEYCODE_MTKIR_CUSTOM_65");
        names.append(KEYCODE_MTKIR_CUSTOM_66, "KEYCODE_MTKIR_CUSTOM_66");
        names.append(KEYCODE_MTKIR_CUSTOM_67, "KEYCODE_MTKIR_CUSTOM_67");
        names.append(KEYCODE_MTKIR_CUSTOM_68, "KEYCODE_MTKIR_CUSTOM_68");
        names.append(KEYCODE_MTKIR_CUSTOM_69, "KEYCODE_MTKIR_CUSTOM_69");
        names.append(KEYCODE_MTKIR_CUSTOM_70, "KEYCODE_MTKIR_CUSTOM_70");
        names.append(KEYCODE_MTKIR_CUSTOM_71, "KEYCODE_MTKIR_CUSTOM_71");
        names.append(KEYCODE_MTKIR_CUSTOM_72, "KEYCODE_MTKIR_CUSTOM_72");
        names.append(KEYCODE_MTKIR_CUSTOM_73, "KEYCODE_MTKIR_CUSTOM_73");
        names.append(KEYCODE_MTKIR_CUSTOM_74, "KEYCODE_MTKIR_CUSTOM_74");
        names.append(KEYCODE_MTKIR_CUSTOM_75, "KEYCODE_MTKIR_CUSTOM_75");
        names.append(KEYCODE_MTKIR_CUSTOM_76, "KEYCODE_MTKIR_CUSTOM_76");
        names.append(KEYCODE_MTKIR_CUSTOM_77, "KEYCODE_MTKIR_CUSTOM_77");
        names.append(KEYCODE_MTKIR_CUSTOM_78, "KEYCODE_MTKIR_CUSTOM_78");
        names.append(KEYCODE_MTKIR_CUSTOM_79, "KEYCODE_MTKIR_CUSTOM_79");
        names.append(KEYCODE_MTKIR_CUSTOM_80, "KEYCODE_MTKIR_CUSTOM_80");
        names.append(KEYCODE_MTKIR_CUSTOM_81, "KEYCODE_MTKIR_CUSTOM_81");
        names.append(KEYCODE_MTKIR_CUSTOM_82, "KEYCODE_MTKIR_CUSTOM_82");
        names.append(KEYCODE_MTKIR_CUSTOM_83, "KEYCODE_MTKIR_CUSTOM_83");
        names.append(KEYCODE_MTKIR_CUSTOM_84, "KEYCODE_MTKIR_CUSTOM_84");
        names.append(KEYCODE_MTKIR_CUSTOM_85, "KEYCODE_MTKIR_CUSTOM_85");
        names.append(KEYCODE_MTKIR_CUSTOM_86, "KEYCODE_MTKIR_CUSTOM_86");
        names.append(KEYCODE_MTKIR_CUSTOM_87, "KEYCODE_MTKIR_CUSTOM_87");
        names.append(KEYCODE_MTKIR_CUSTOM_88, "KEYCODE_MTKIR_CUSTOM_88");
        names.append(KEYCODE_MTKIR_CUSTOM_89, "KEYCODE_MTKIR_CUSTOM_89");
        names.append(KEYCODE_MTKIR_CUSTOM_90, "KEYCODE_MTKIR_CUSTOM_90");
        names.append(KEYCODE_MTKIR_CUSTOM_91, "KEYCODE_MTKIR_CUSTOM_91");
        names.append(KEYCODE_MTKIR_CUSTOM_92, "KEYCODE_MTKIR_CUSTOM_92");
        names.append(KEYCODE_MTKIR_CUSTOM_93, "KEYCODE_MTKIR_CUSTOM_93");
        names.append(KEYCODE_MTKIR_CUSTOM_94, "KEYCODE_MTKIR_CUSTOM_94");
        names.append(KEYCODE_MTKIR_CUSTOM_95, "KEYCODE_MTKIR_CUSTOM_95");
        names.append(KEYCODE_MTKIR_CUSTOM_96, "KEYCODE_MTKIR_CUSTOM_96");
        names.append(KEYCODE_MTKIR_CUSTOM_97, "KEYCODE_MTKIR_CUSTOM_97");
        names.append(KEYCODE_MTKIR_CUSTOM_98, "KEYCODE_MTKIR_CUSTOM_98");
        names.append(KEYCODE_MTKIR_CUSTOM_99, "KEYCODE_MTKIR_CUSTOM_99");
        names.append(KEYCODE_MTKIR_CUSTOM_100, "KEYCODE_MTKIR_CUSTOM_100");
		//add tcl keycode defined  by yjw 20140502 start
		names.append(KEYCODE_TCL_MITV, "KEYCODE_TCL_MITV");
		names.append(KEYCODE_TCL_USB, "KEYCODE_TCL_USB");
		names.append(KEYCODE_TCL_USB_MENU, "KEYCODE_TCL_USB_MENU");
		names.append(KEYCODE_TCL_SWING_R1, "KEYCODE_TCL_SWING_R1");
		names.append(KEYCODE_TCL_SWING_R2, "KEYCODE_TCL_SWING_R2");
		names.append(KEYCODE_TCL_SWING_R3, "KEYCODE_TCL_SWING_R3");
		names.append(KEYCODE_TCL_SWING_R4, "KEYCODE_TCL_SWING_R4");
		names.append(KEYCODE_TCL_SWING_L1, "KEYCODE_TCL_SWING_L1");
		names.append(KEYCODE_TCL_SWING_L2, "KEYCODE_TCL_SWING_L2");
		names.append(KEYCODE_TCL_SWING_L3, "KEYCODE_TCL_SWING_L3");
		names.append(KEYCODE_TCL_SWING_L4, "KEYCODE_TCL_SWING_L4");
		names.append(KEYCODE_TCL_VGR_LEFT, "KEYCODE_TCL_VGR_LEFT");
		names.append(KEYCODE_TCL_VGR_RIGHT, "KEYCODE_TCL_VGR_RIGHT");
		names.append(KEYCODE_TCL_VGR_TAP, "KEYCODE_TCL_VGR_TAP");
		names.append(KEYCODE_TCL_VGR_WAVE, "KEYCODE_TCL_VGR_WAVE");
		names.append(KEYCODE_TCL_VGR_WAVE_LEFT, "KEYCODE_TCL_VGR_WAVE_LEFT");
		names.append(KEYCODE_TCL_VGR_WAVE_RIGHT, "KEYCODE_TCL_VGR_WAVE_RIGHT");
		names.append(KEYCODE_TCL_VGR_ACTIVE, "KEYCODE_TCL_VGR_ACTIVE");
		names.append(KEYCODE_TCL_VGR_DEACTIVE, "KEYCODE_TCL_VGR_DEACTIVE");
		names.append(KEYCODE_TCL_BODY_SENSOR, "KEYCODE_TCL_BODY_SENSOR");
		
		names.append(KEYCODE_TCL_EPG, "KEYCODE_TCL_EPG");
		names.append(KEYCODE_TCL_FAVORITE, "KEYCODE_TCL_FAVORITE");
		names.append(KEYCODE_TCL_SERACH, "KEYCODE_TCL_SERACH");
		names.append(KEYCODE_TCL_UP_LEFT, "KEYCODE_TCL_UP_LEFT");
		names.append(KEYCODE_TCL_UP_RIGHT, "KEYCODE_TCL_UP_RIGHT");
		names.append(KEYCODE_TCL_DOWN_LEFT, "KEYCODE_TCL_DOWN_LEFT");
		names.append(KEYCODE_TCL_DOWN_RIGHT, "KEYCODE_TCL_DOWN_RIGHT");
		names.append(KEYCODE_TCL_CIRCLE_CLOCKWISE, "KEYCODE_TCL_CIRCLE_CLOCKWISE");
		names.append(KEYCODE_TCL_CIRCLE_CTR_CLOCKWISE, "KEYCODE_TCL_CIRCLE_CTR_CLOCKWISE");
		names.append(KEYCODE_TCL_GESTURE_X, "KEYCODE_TCL_GESTURE_X");
		names.append(KEYCODE_TCL_GESTURE_ALPHA, "KEYCODE_TCL_GESTURE_ALPHA");
		names.append(KEYCODE_TCL_GESTURE_MUTE, "KEYCODE_TCL_GESTURE_MUTE");
		names.append(KEYCODE_TCL_WIDGET, "KEYCODE_TCL_WIDGET");
		names.append(KEYCODE_TCL_UP, "KEYCODE_TCL_UP");
		names.append(KEYCODE_TCL_DOWN, "KEYCODE_TCL_DOWN");
		names.append(KEYCODE_TCL_LEFT, "KEYCODE_TCL_LEFT");
		names.append(KEYCODE_TCL_RIGHT, "KEYCODE_TCL_RIGHT");
		names.append(KEYCODE_TCL_TP_LPRESSD, "KEYCODE_TCL_TP_LPRESSD");
		names.append(KEYCODE_TCL_TP_LPRESSU, "KEYCODE_TCL_TP_LPRESSU");
		names.append(KEYCODE_TCL_QUICK_MENU, "KEYCODE_TCL_QUICK_MENU");
		names.append(KEYCODE_TCL_START_MOUSE, "KEYCODE_TCL_START_MOUSE");
		names.append(KEYCODE_TCL_MOUSE_BSB_LEFT, "KEYCODE_TCL_MOUSE_BSB_LEFT");
		names.append(KEYCODE_TCL_MOUSE_BSB_RIGHT, "KEYCODE_TCL_MOUSE_BSB_RIGHT");
		names.append(KEYCODE_TCL_FOCUS_BSB_LEFT, "KEYCODE_TCL_FOCUS_BSB_LEFT");
		names.append(KEYCODE_TCL_FOCUS_BSB_RIGHT, "KEYCODE_TCL_FOCUS_BSB_RIGHT");

		names.append(KEYCODE_TCL_TOUCH_BEEN_MAX, "KEYCODE_TCL_TOUCH_BEEN_MAX");
		names.append(KEYCODE_TCL_TOUCH_BEEN_MIN, "KEYCODE_TCL_TOUCH_BEEN_MIN");
		names.append(KEYCODE_TCL_TOUCH_ROTATE_LEFT, "KEYCODE_TCL_TOUCH_ROTATE_LEFT");
		names.append(KEYCODE_TCL_TOUCH_ROTATE_RIGHT, "KEYCODE_TCL_TOUCH_ROTATE_RIGHT");
		
		names.append(KEYCODE_TCL_JOYSTICK_R_AXIS_UP, "KEYCODE_TCL_JOYSTICK_R_AXIS_UP");
		names.append(KEYCODE_TCL_JOYSTICK_R_AXIS_DOWN, "KEYCODE_TCL_JOYSTICK_R_AXIS_DOWN");
		names.append(KEYCODE_TCL_JOYSTICK_R_AXIS_LEFT, "KEYCODE_TCL_JOYSTICK_R_AXIS_LEFT");
		names.append(KEYCODE_TCL_JOYSTICK_R_AXIS_RIGHT, "KEYCODE_TCL_JOYSTICK_R_AXIS_RIGHT");		
		names.append(KEYCODE_TCL_SHARE, "KEYCODE_TCL_SHARE");
		names.append(KEYCODE_TCL_POUND, "KEYCODE_TCL_POUND");
		names.append(KEYCODE_TCL_MOUSE_IDLE_FADE, "KEYCODE_TCL_MOUSE_IDLE_FADE");
		names.append(KEYCODE_TCL_RC_RF_UNCONNECT, "KEYCODE_TCL_RC_RF_UNCONNECT");
		names.append(KEYCODE_TCL_ARK, "KEYCODE_TCL_ARK");
		names.append(KEYCODE_TCL_DISNEY_GAME, "KEYCODE_TCL_DISNEY_GAME");
		names.append(KEYCODE_TCL_DISNEY_SHOP, "KEYCODE_TCL_DISNEY_SHOP");
		names.append(KEYCODE_TCL_RF_LINK_S, "KEYCODE_TCL_RF_LINK_S");
		names.append(KEYCODE_TCL_RF_LINK_F, "KEYCODE_TCL_RF_LINK_F");
		names.append(KEYCODE_TCL_UNKNOWN_KEY_REPORT, "KEYCODE_TCL_UNKNOWN_KEY_REPORT");
		names.append(KEYCODE_TCL_HISTORY, "KEYCODE_TCL_HISTORY");
		names.append(KEYCODE_TCL_NUMBER, "KEYCODE_TCL_NUMBER");
		names.append(KEYCODE_TCL_USB_MEDIA, "KEYCODE_TCL_USB_MEDIA");
		names.append(KEYCODE_TCL_UD_DG_S, "KEYCODE_TCL_UD_DG_S");
		names.append(KEYCODE_TCL_UD_DG_F, "KEYCODE_TCL_UD_DG_F");
		names.append(KEYCODE_TCL_UD_DG_B, "KEYCODE_TCL_UD_DG_B");
		names.append(KEYCODE_TCL_FORCE_AMAZON, "KEYCODE_TCL_FORCE_AMAZON");
		names.append(KEYCODE_TCL_FORCE_NETFLIX, "KEYCODE_TCL_FORCE_NETFLIX");
		names.append(KEYCODE_TCL_FORCE_VUDU, "KEYCODE_TCL_FORCE_VUDU");
		names.append(KEYCODE_TCL_FORCE_MGO, "KEYCODE_TCL_FORCE_MGO");
		names.append(KEYCODE_TCL_FORCE_YOUTUBE, "KEYCODE_TCL_FORCE_YOUTUBE");
		names.append(KEYCODE_TCL_FORCE_HULU, "KEYCODE_TCL_FORCE_HULU");
		names.append(KEYCODE_TCL_PIP, "KEYCODE_TCL_PIP");
		names.append(KEYCODE_TCL_FORCE_SEARCH, "KEYCODE_TCL_FORCE_SEARCH");
		names.append(KEYCODE_TCL_FORCE_PRIMETIME, "KEYCODE_TCL_FORCE_PRIMETIME");
		names.append(KEYCODE_TCL_NETFLIX_FORWARD, "KEYCODE_TCL_NETFLIX_FORWARD");
		names.append(KEYCODE_TCL_NETFLIX_PLAYPAUSE, "KEYCODE_TCL_NETFLIX_PLAYPAUSE");
		names.append(KEYCODE_TCL_NETFLIX_NEXT, "KEYCODE_TCL_NETFLIX_NEXT");
		names.append(KEYCODE_TCL_NETFLIX_FF, "KEYCODE_TCL_NETFLIX_FF");
		names.append(KEYCODE_TCL_NETFLIX_STOP, "KEYCODE_TCL_NETFLIX_STOP");
		names.append(KEYCODE_TCL_NETFLIX_FB, "KEYCODE_TCL_NETFLIX_FB");
		names.append(KEYCODE_TCL_RC_SLEEP, "KEYCODE_TCL_RC_SLEEP");
		names.append(KEYCODE_TCL_SET, "KEYCODE_TCL_SET");
		names.append(KEYCODE_TCL_NFC_EA, "KEYCODE_TCL_NFC_EA");
		names.append(KEYCODE_TCL_SEARCH, "KEYCODE_TCL_SEARCH");
		names.append(KEYCODE_TCL_COLLECT, "KEYCODE_TCL_COLLECT");
		names.append(KEYCODE_TCL_LAST, "KEYCODE_TCL_LAST");
		names.append(KEYCODE_TCL_ALL_APP, "KEYCODE_TCL_ALL_APP");
		names.append(KEYCODE_TCL_MORE, "KEYCODE_TCL_MORE");
		names.append(KEYCODE_TCL_LANG, "KEYCODE_TCL_LANG");
		names.append(KEYCODE_TCL_SUBTITLE, "KEYCODE_TCL_SUBTITLE");
		names.append(KEYCODE_TCL_TEXT, "KEYCODE_TCL_TEXT");
		names.append(KEYCODE_TCL_MIRACAST, "KEYCODE_TCL_MIRACAST");
		names.append(KEYCODE_TCL_VOICE, "KEYCODE_TCL_VOICE");
		names.append(KEYCODE_TCL_ROLE, "KEYCODE_TCL_ROLE");
		names.append(KEYCODE_TCL_LIST, "KEYCODE_TCL_LIST");
		names.append(KEYCODE_TCL_DOT, "KEYCODE_TCL_DOT");   
		names.append(KEYCODE_TCL_SENSOR_WAKEUP, "KEYCODE_TCL_SENSOR_WAKEUP");
		names.append(KEYCODE_TCL_LOW_VOLTAGE, "KEYCODE_TCL_LOW_VOLTAGE");   
		names.append(KEYCODE_TCL_RF_LINK_EXCEPTION, "KEYCODE_TCL_RF_LINK_EXCEPTION");   //tcl keycode total number 98
		names.append(KEYCODE_TCL_MEDIA_FAST_REVERSE, "KEYCODE_TCL_MEDIA_FAST_REVERSE");

		//add tcl keycode defined  by yjw 20140502 end
