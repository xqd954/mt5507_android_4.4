...
public class TCLButton extends Button {
    ...
    public TCLButton(Context context, AttributeSet attrs) {
      ...
      this(context, attrs, com.android.internal.R.attr.tclbuttonblackStyle); //modified by lyp
    }

    public TCLButton(Context context, AttributeSet attrs, int defStyle) {
        //super(context, attrs, defStyle);
        super(new ContextThemeWrapper(context, com.android.internal.R.style.Theme), attrs, defStyle);
    }
}
