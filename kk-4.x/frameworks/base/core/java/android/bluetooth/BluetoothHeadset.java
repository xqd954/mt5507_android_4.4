...
//add by wangyoulin for userstate
import android.content.Intent;
//end by wangyoulin
...
public final class BluetoothHeadset implements BluetoothProfile {
    ...
    public boolean connect(BluetoothDevice device) {
        ...
        if (mService != null && isEnabled() &&
            ...
            try {
//add by wangyoulin for userstate
	Intent userstate = new Intent("android.tcl.usagestats.external.open");
	userstate.putExtra("type", "bluetoothheadset");
	int pid = android.os.Process.myPid();
	userstate.putExtra("pid", Integer.toString(pid));
	Context.sendBroadcastStatic(userstate);
//end by wangyoulin
    ...
    public boolean disconnect(BluetoothDevice device) {
        ...
        if (mService != null && isEnabled() &&
            ...
            try {
//add by wangyoulin for userstate
	Intent userstate = new Intent("android.tcl.usagestats.external.close");
	userstate.putExtra("type", "bluetoothheadset");
	int pid = android.os.Process.myPid();
	userstate.putExtra("pid", Integer.toString(pid));
	Context.sendBroadcastStatic(userstate);
