...
interface IPowerManager
{
    ...
    int getShutdownReason();
    void setShutdownReason(int reason);
    int getWakeupReason();
    void setWakeupReason(int ctrl_value);
    int setPanelOn();    
    int setPanelOff();
    int setAudioMute();
    int setAudioUnMute();
    boolean isBGMState();
    int requestEnterSuspendFromBGM();
    int requestEnterResumeFromBGM();
    int setCustomBGMapplicable(boolean isbgmapplicable);
    int registerWhiteListByCustomer(String packageName, boolean isWhitelist);
    int unregisterWhiteListByCustomer(String packageName);
