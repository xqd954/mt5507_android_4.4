...
public interface IMountService extends IInterface {
  ...
  /* Begin to modify by Sarah Zhang(zxia@tcl.com) */
            /**
             * Gets the fstype of a volume via its mountpoint.
             */
            public String getVolumeFstype(String mountPoint) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                String _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeString(mountPoint);
                    mRemote.transact(Stub.TRANSACTION_getVolumeFstype, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.readString();
                } finally {
                    _reply.recycle();
             ...
             */
            public String getVolumeLabel_TCL(String mountPoint) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                String _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeString(mountPoint);
                    mRemote.transact(Stub.TRANSACTION_getVolumeLabel_TCL, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.readString();
                } finally {
                    _reply.recycle();
            ...
            /**
             * Gets the devpath of a volume via its mountpoint.
             */
            public String getVolumeDevpath(String mountPoint) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                String _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeString(mountPoint);
                    mRemote.transact(Stub.TRANSACTION_getVolumeDevpath, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.readString();
                } finally {
                    _reply.recycle();
	...
	//}}
        ...
        static final int TRANSACTION_getVolumeFstype = IBinder.FIRST_CALL_TRANSACTION + 43;

        static final int TRANSACTION_getVolumeLabel_TCL = IBinder.FIRST_CALL_TRANSACTION + 44;

        static final int TRANSACTION_getVolumeUuid = IBinder.FIRST_CALL_TRANSACTION + 45;
		//static final int TRANSACTION_getMountedSecureContainerList = IBinder.FIRST_CALL_TRANSACTION + 46;
        static final int TRANSACTION_getVolumeDevpath = IBinder.FIRST_CALL_TRANSACTION + 47;
		/* End to modify by Sarah Zhang(zxia@tcl.com) */
		//}}
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply,
            ...
            switch (code) {
				...
				//{{gaodw@tcl.com patch from ms628.
				/* Begin to modify by Sarah Zhang(zxia@tcl.com) */
                case TRANSACTION_getVolumeFstype: {
                    data.enforceInterface(DESCRIPTOR);
                    String mountPoint;
                    mountPoint = data.readString();
                    String fstype = getVolumeFstype(mountPoint);
                    reply.writeNoException();
                    reply.writeString(fstype);
                    return true;
                }
				case TRANSACTION_getVolumeLabel_TCL: {
                    data.enforceInterface(DESCRIPTOR);
                    String mountPoint;
                    mountPoint = data.readString();
                    String label = getVolumeLabel_TCL(mountPoint);
                    reply.writeNoException();
                ...
                case TRANSACTION_getVolumeUuid: {
                    ...
                    String mountPoint;
                    mountPoint = data.readString();
                    String uuid = getVolumeUuid(mountPoint);
                    reply.writeNoException();
                    reply.writeString(uuid);
                    return true;
                }
                case TRANSACTION_getVolumeDevpath: {
                    data.enforceInterface(DESCRIPTOR);
                    String mountPoint;
                    mountPoint = data.readString();
                    String devpath = getVolumeDevpath(mountPoint);
                    reply.writeNoException();
                    reply.writeString(devpath);
                    return true;
                }
		/* End to modify by Sarah Zhang(zxia@tcl.com) */
		//}}
