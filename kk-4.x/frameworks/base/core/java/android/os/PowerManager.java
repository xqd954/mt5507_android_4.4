...
public final class PowerManager {
	...
	/*The shutdown reason define*/
	public static final int MTK_SHUTDOWN_REASON_IR = 1;
	public static final int MTK_SHUTDOWN_REASON_KEYPAD = 2;
	public static final int MTK_SHUTDOWN_REASON_TIMER = 3;
	public static final int MTK_SHUTDOWN_REASON_CEC = 4;
   ...
   /**
	...
	/**
	* return value mean shutdown by different device:
	* 0 is init value.
	* 1 mean IR
	* 2 mean Keypad
	* 3 mean Timer
	...
	*/
	public int getShutdownReason() {
		try {
			return mService.getShutdownReason();
		} catch (RemoteException e) {
			return -1;
		}
	}
    ...
    public void setShutdownReason(int reason) {
		try {
			mService.setShutdownReason(reason);
		} catch (RemoteException e) {
		}
	}
	...
	* {@samplecode
	* PowerManager pm = (PowerManager) getSystemService(Context.POWER_SERVICE);
	* int ctrl_value = pm.getWakeupReason();
	* }
	* </p>
	*
	...
	*/
	public int getWakeupReason() {
		try {
			return mService.getWakeupReason();
		} catch (RemoteException e) {
			return -1;
		}
	}
	...
	* PowerManager pm = (PowerManager) getSystemService(Context.POWER_SERVICE);
	* int ctrl_value = xx;
	* pm.setWakeupReason(ctrl_value);
	* }
	* </p>
	*/
	public void setWakeupReason(int ctrl_value) {
		try {
			mService.setWakeupReason(ctrl_value);
		} catch (RemoteException e) {
		}
	}
	...
	*/	
	public int setAudioUnMute() {
		try {
			return mService.setAudioUnMute();
		} catch (RemoteException e) {
			return -1;
		}	 
	}
	...
	/**
	* judge Current is BGM State or not.
	* <p>
	* 
	* </p><p>
	* {@samplecode
	* PowerManager pm = (PowerManager) getSystemService(Context.POWER_SERVICE);
	* boolean isBGMState = pm.isBGMState();
	* }
	* </p>
	*/
	public boolean isBGMState(){	
		try {
			return mService.isBGMState();
		} catch (RemoteException e) {
			return false;
		}
	}
	...
	/**
	* requestEnterSuspendFromBGM called when you want to go to suspend.
	* <p>
	* 
	* </p><p>
	* {@samplecode
	* PowerManager pm = (PowerManager) getSystemService(Context.POWER_SERVICE);
	* pm.requestEnterSuspendFromBGM();
	* }
	* </p>
	*/
	public int requestEnterSuspendFromBGM(){	
		try {
			return mService.requestEnterSuspendFromBGM();
		} catch (RemoteException e) {
			return -1;
		}
	}
	...
	/**
	* requestEnterResumeFromBGM called when you want to go to resume.
	* <p>
	* 
	* </p><p>
	* {@samplecode
	* PowerManager pm = (PowerManager) getSystemService(Context.POWER_SERVICE);
	* pm.requestEnterResumeFromBGM();
	* }
	* </p>
	*/
	public int requestEnterResumeFromBGM(){ 
		try {
			return mService.requestEnterResumeFromBGM();
		} catch (RemoteException e) {
			return -1;
		}
	}
	...
	/**
	* setCustomBGMapplicable For ARIB only, called when you want to change BGM applicable or not
	* <p>
	* 
	* </p><p>
	* {@samplecode
	* PowerManager pm = (PowerManager) getSystemService(Context.POWER_SERVICE);
	* pm.setCustomBGMapplicable(false/true);
	* }
	* </p>
	*/
	public int setCustomBGMapplicable(boolean isbgmapplicable){ 
		try {
			return mService.setCustomBGMapplicable(isbgmapplicable);
		} catch (RemoteException e) {
			return -1;
		}
	}
	...
	* {@samplecode
	* PowerManager pm = (PowerManager) getSystemService(Context.POWER_SERVICE);
	* pm.registerWhiteListByCustomer("com.xxx.xxx",  true);
	* }
	* </p>
	*/
	public int registerWhiteListByCustomer(String packageName, boolean isWhitelist){
		try {
			return mService.registerWhiteListByCustomer(packageName, isWhitelist);
		} catch (RemoteException e) {
			return -1;
		}
	}
	...
	* {@samplecode
	* PowerManager pm = (PowerManager) getSystemService(Context.POWER_SERVICE);
	* pm.unregisterWhiteListByCustomer("com.xxx.xxx");
	* }
	* </p>
	*/
	public int unregisterWhiteListByCustomer(String packageName){
		try {
			return mService.unregisterWhiteListByCustomer(packageName);
		} catch (RemoteException e) {
			return -1;
		}
	}
