...
public class Intent implements Parcelable, Cloneable {
   ...
   /**
	...
	/**
	* Support warm boot: when go to suspend, this intent will be sent.
	* @hide
	*/
	public static final String ACTION_STANDBY = "android.intent.action.ACTION_STANDBY";

	/**
	* Support warm boot: when go to resume, this intent will be sent.
	* @hide
	*/
	public static final String ACTION_PANEL_ON = "android.intent.action.ACTION_PANEL_ON";

	/**
	* Support warm boot: just to check which customer app should be resume when go to resume.
	* @hide
	*/
	@SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
	public static final String ACTION_REQUEST_TOP_RESUME = "android.intent.action.ACTION_REQUEST_TOP_RESUME";

	/**
	* Support warm boot: when deteck no user Action for 5 min, this intent will be sent.
	* @hide
	*/
	public static final String ACTION_NO_ACTION_TIMEOUT = "android.intent.action.ACTION_NO_ACTION_TIMEOUT";

	/**
	* Support warm boot: when prepare go to shutdown flow.
	* @hide
	*/
