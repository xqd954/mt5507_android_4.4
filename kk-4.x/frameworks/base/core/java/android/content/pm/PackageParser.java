...
*/
    ...
    private Activity parseActivity(Package owner, Resources res,
        ...
        if (!receiver) {
            ...
            a.info.displayMode = sa.getInt(
                    com.android.internal.R.styleable.AndroidManifestActivity_displayMode,
                    ActivityInfo.DISPLAY_MODE_UNSPECIFIED);
            ...
            a.info.softInputMode = sa.getInt(
                    ...
                    0);
            Slog.e(TAG, "a.info.softInputMode: 0x" + Integer.toHexString(a.info.softInputMode));
            a.info.softInputMode = android.view.WindowManager.LayoutParams.SOFT_INPUT_ADJUST_NOTHING;
        } else {
    ...
    private Activity parseActivityAlias(Package owner, Resources res,
        ...
        info.displayMode = target.info.displayMode;
