...
public class ActivityInfo extends ComponentInfo
    ...
    public static final int DISPLAY_MODE_UNSPECIFIED = -1;
    public static final int DISPLAY_MODE_FHD = 0;
    public static final int DISPLAY_MODE_UHD = 1;
    public static final int DISPLAY_MODE_720P = 2;

    public int displayMode = DISPLAY_MODE_UNSPECIFIED;
    ...
    public void dump(Printer pw, String prefix) {
        ...
        if (screenOrientation != SCREEN_ORIENTATION_UNSPECIFIED
                || displayMode != DISPLAY_MODE_UNSPECIFIED
