...
int ifc_configure(const char *ifname, in_addr_t address, uint32_t prefixLength, in_addr_t gateway, in_addr_t dns1, in_addr_t dns2);
...
// MStar Android Patch Begin
// function migrated from libnetutils/ifc_utils.c
uint32_t android_net_utils_ipv4NetmaskToPrefixLength(jint mask)
{
    mask = ntohl(mask);
        ...
        jobject dhcpResults, bool renew)
{
	...
	//{{lvh@tcl , add string init , 2014-02-26
        ...
        jint dns2)
{
    int result;
    uint32_t lease;
    uint32_t prefixLength = android_net_utils_ipv4NetmaskToPrefixLength(mask);
...
static jboolean android_net_utils_clearAddresses(JNIEnv* env, jobject clazz, jstring ifname)
{
    int result;
...
static JNINativeMethod gNetworkUtilMethods[] = {
    ...
    { "clearAddresses", "(Ljava/lang/String;)Z",  (void *)android_net_utils_clearAddresses },
    // MStar Android Patch End
};
