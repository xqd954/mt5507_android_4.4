...
static jint
android_media_AudioSystem_setStreamMute(JNIEnv *env, jobject thiz, jint stream, jboolean mute)
{
    return (jint) AudioSystem::setStreamMute(static_cast <audio_stream_type_t>(stream), mute);
}

static jboolean
android_media_AudioSystem_getStreamMute(JNIEnv *env, jobject thiz, jint stream)
{
	bool mute = false;
	// Should we check the status of AudioSystem?
	// !!FIXME!!
    AudioSystem::getStreamMute(static_cast <audio_stream_type_t>(stream), &mute);
...
static JNINativeMethod gMethods[] = {
    ...
    {"setStreamMute", "(IZ)I",     (void *)android_media_AudioSystem_setStreamMute},
	  {"getStreamMute", "(I)Z",	   (void *)android_media_AudioSystem_getStreamMute},
};
