...
public:
    ...
    virtual void setPointerState(bool enablepointer) = 0;
	//end
...
public:
    ...
    //add by gaodw. fade mouse. patch from ms918.
	virtual void setPointerState(bool enablepointer);
	//end
...
private:
    ...
    //added by chenglan   set  the flag of Remote Controller 
#ifdef NEED_CHANGE_MODE
	#define SCANCODE_LEFT_MOUSE  272
	#define SCANCODE_CENTER 28
	#define SCANCODE_DPAD_LEFT 105
	#define SCANCODE_DPAD_RIGHT 106
	#define SCANCODE_DPAD_UP 103
	#define SCANCODE_DPAD_DOWN 108
	#define SCANCODE_MOUSE_WAKE 704
	#define AKEYCODE_MOUSE_WAKE 4021
	enum {
		LOCAL_INDEX_FIRST ,
		LOCAL_INDEX_SECOND ,
		LOCAL_INDEX_THIRD ,
	...
	bool mPowerOn;
    uint32_t isCursor;
	void removeFocusEventLocked(RawEvent* rawEvents, size_t count);
#endif
	//end added 
