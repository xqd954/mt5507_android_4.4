...
public class InputManagerService extends IInputManager.Stub
	...
	private static native void nativeDisablePointer(int ptr);
	private static native void nativeEnablePointer(int ptr);
	//end
	...
	//add by gaodw. fade mouse. patch from ms918
	  public void enablePointer(){
	            nativeEnablePointer(mPtr);
	   }
	 
	   public void disablePointer(){
	            nativeDisablePointer(mPtr);
	   } 
	 //end
