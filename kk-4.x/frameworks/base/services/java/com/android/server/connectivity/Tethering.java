...
public class Tethering extends INetworkManagementEventObserver.Stub {
    ...
    public int tether(String iface) {
        ...
        if (sm == null) {
			...
			Log.e(TAG, "interface Event exception flow ; try to force tether again" + iface);
			sm = new TetherInterfaceSM(iface, mLooper, false);
            mIfaces.put(iface, sm);
            sm.start();
			sm.sendMessageDelayed(TetherInterfaceSM.CMD_TETHER_REQUESTED,800);
