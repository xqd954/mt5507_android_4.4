...
/*
        Log.d(TAG,"WifiService start call wifiIsDongleIn");
        wifiIsDongleIn();
        
        Log.d(TAG,"WifiService end call wifiIsDongleIn");
       DeviceManager.getInstance().addListener(mDevListener);
*/
//end by wangyoulin
    ...
    private DeviceManagerListener mDevListener = new DeviceManagerListener() { 
        public void onEvent(DeviceManagerEvent event) {
            ...
            case DeviceManagerEvent.productconnected:
                Log.d(TAG, "mDevListener: start call wifiIsDongleIn.");
                int isdongle = wifiIsDongleIn();
                Log.d(TAG, "mDevListener: finish call:"+"isdongle:"+isdongle);
               if (isdongle == 0) {
            ...
            case DeviceManagerEvent.wificonnected:
                ...
                boolean wifiEnabled = mSettingsStore.isWifiToggleEnabled();
                 Slog.i(TAG, "WifiService starting up with Wi-Fi wificonnected" +
            ...
            case DeviceManagerEvent.productdisconnected:
                Log.d(TAG, "mDevListener: start call wifiIsDongleOut.");
                wifiIsDongleOut();
                Log.d(TAG, "mDevListener: finish call wifiIsDongleOut.");
				Log.d(TAG, "getWifiApEnabledState " + getWifiApEnabledState());
				if(getWifiApEnabledState() == WIFI_AP_STATE_ENABLED || getWifiApEnabledState() == WIFI_AP_STATE_DISABLING)
				{
            ...
            default:
                Log.d(TAG, "mDevListener:  WIFI NULL NULL.");
                break;
            }
        }   
    };
...
//end by wangyoulin
    ...
    public void startScan(WorkSource workSource) {
        ...
        Slog.e(TAG, "startScan invoked");
		mWifiStateMachine.mScanFromApp = true;//zengyy
...
/**
   ...
   /* public void startScan() {
    ...
    public String scanResults() {
    	...
    	return  mWifiStateMachine.scanResults();
		
    }
    public boolean scan() {
        enforceAccessPermission();
        
        return  mWifiStateMachine.scan();
    ...
    public int wifi0Check() {
    	...
    	return  mWifiStateMachine.wifi0Check();
    }

	  public int wifiIsDongleIn() {
    	enforceAccessPermission();
    	
    	return  mWifiStateMachine.wifiIsDongleIn();
    	...
    	return  mWifiStateMachine.wifiIsDongleOut();
    	...
    	return  mWifiStateMachine.startSupplicant(p2pSupported);
    	...
    	return  mWifiStateMachine.connectToSupplicant();
    ...
    public boolean enableWoWL(boolean enable){
        return WifiNative.wifiEnableWoWL(mInterfaceName, enable);
