    ...
    implements WindowManagerService.OnHardKeyboardStatusChangeListener
{
    ...
    /* MTK Added */
    public void setSystemUiBarHight(int hight) {
        if (mBar != null) {
            try {
                mBar.setSystemUiBarHight(hight);
            } catch (RemoteException ex) {
            }
        }
    }
    ...
    public IBinder addNotification(StatusBarNotification notification) {
        synchronized (mNotifications) {
            ...
            {
                /* no-SystemUI case, for the alarm test of cts verifier */
    		    if (android.os.SystemProperties.get("ro.def_systemui_existed").equals("0"))
    		    {
                    android.util.Log.d(TAG, "mBar is null");                    
                    if(notification.getNotification().fullScreenIntent != null)
                    {
                        android.util.Log.d(TAG, "Notification has fullScreenIntent; sending fullScreenIntent");
                        try {
