...
final class WindowState implements WindowManagerPolicy.WindowState {
    ...
    public void computeFrameLw(Rect pf, Rect df, Rect of, Rect cf, Rect vf, Rect dcf) {
        ...
        if (!mParentFrame.equals(pf)) {
            ...
            //        + " to " + pf);
			/*if(0 == SystemProperties.getInt("ro.mtk.pip.fullscreen",0)){
				if(mParentFrame.top - pf.top == 33){
					Settings.System.putInt(mContext.getContentResolver(),"fullScreenOrNot",1);
				}else if (mParentFrame.top - pf.top == -33){
					Settings.System.putInt(mContext.getContentResolver(),"fullScreenOrNot",0);
				}
			}*/
            mParentFrame.set(pf);
