...
public class DeviceStorageMonitorService extends Binder {
    ...
    private static final boolean localLOGV = true; //false;
    ...
    private static final long DEFAULT_CHECK_INTERVAL = MONITOR_INTERVAL*30*1000;//MONITOR_INTERVAL*60*1000;
    ...
    */
    ...
    private final void checkMemory(boolean checkCache) {
        ...
        if(mClearingCache) {
	     ...
	     if (localLOGV)  Slog.v(TAG, "mMemLowThreshold="+mMemLowThreshold);
		   ...
		   if (localLOGV)  Slog.v(TAG, "mFreeMem < mMemLowThreshold  and send  ACTION_DEVICE_STORAGE_LOW_TEST ");
		   
  		   Intent mIntent = new Intent("ACTION_DEVICE_STORAGE_LOW_TEST");
