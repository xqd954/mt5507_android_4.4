...
final class ProcessList {
    ...
    private void updateOomLevels(int displayWidth, int displayHeight, boolean write) {
        ...
        if ("true".equals(SystemProperties.get("ro.config.low_ram", "false"))) {
            //adjust the LMK minfree values, it seems LMK would be triggered when cached memory is smaller than each minfree value
            //(1M,12M,16M,24M,28M,32M)*3
            /*
            mOomMinFree[0] = 1024*3;
            mOomMinFree[1] = 12288*3;
            mOomMinFree[2] = 16384*3;
            mOomMinFree[3] = 24576*3;
            mOomMinFree[4] = 28672*3;
            mOomMinFree[5] = 32768*3;
	*/	
            mOomMinFree[0] = 1024*4;
            mOomMinFree[1] = 2048*4;
            mOomMinFree[2] = 4096*4;
            mOomMinFree[3] = 8192*4;
            mOomMinFree[4] = 10240*4;
            mOomMinFree[5] = 20480*4;
