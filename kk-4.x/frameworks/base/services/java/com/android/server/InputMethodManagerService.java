...
import android.os.SystemProperties; //add spike
...
//add by spike
	InputMethodInfo mImi1 = mMethodMap.get(mCurMethodId);
	if(mImi1.getPackageName().equals("com.iflytek.inputmethod.pad")||mImi1.getPackageName().equals("com.iflytek.xiri.ime"))
	{
		SystemProperties.set("sys.voice.recorder","1"); 					
	}  
//end by spike
        mShowRequested = true;
    ...
    boolean hideCurrentInputLocked(int flags, ResultReceiver resultReceiver) {
        ...
        SystemProperties.set("sys.voice.recorder","0");  //add spike
        mInputShown = false;
