...
static void android_server_InputManager_nativeDisablePointer(JNIEnv* env, jclass clazz, jint ptr) {
    NativeInputManager* im = reinterpret_cast<NativeInputManager*>(ptr);
    im->getInputManager()->getReader()->setPointerState(true);
           
}
 
static void android_server_inputManager_nativeEnablePointer(JNIEnv* env, jclass clazz, jint ptr) {
 
    NativeInputManager* im = reinterpret_cast<NativeInputManager*>(ptr);
    im->getInputManager()->getReader()->setPointerState(false);
}
//duanliang end
//end
// ----------------------------------------------------------------------------
...
static JNINativeMethod gInputManagerMethods[] = {
	...
	//add by gaodw. fade mouse. patch from ms918.
	//duanliang for cusor fade
    { "nativeDisablePointer", "(I)V",
            (void *)android_server_InputManager_nativeDisablePointer },
    { "nativeEnablePointer", "(I)V",
                                    (void *)android_server_inputManager_nativeEnablePointer },  
	//duanliang end   
	//end 
};
