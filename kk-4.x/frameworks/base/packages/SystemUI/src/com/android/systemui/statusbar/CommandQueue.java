...
public class CommandQueue extends IStatusBar.Stub {
    ...
    /* MTK Added */
    private static final int MSG_SET_SYSTEM_UI_BAR_HIGHT    = 17 << MSG_SHIFT;
    /* MTK End */
    ...
    public void setSystemUiBarHight(int hight) {
        synchronized(mList) {
            mHandler.obtainMessage(MSG_SET_SYSTEM_UI_BAR_HIGHT, hight, 
                0,null).sendToTarget();
        }
    }
    /* MTK End */
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case MSG_SET_WINDOW_STATE:
                    ...
                    break;
                /* MTK Added */
                case MSG_SET_SYSTEM_UI_BAR_HIGHT:
                    mCallbacks.setSystemUiBarHight(msg.arg1);
                    break;
                /* MTK End */
            }
        }
