...
public class WifiP2pDevice implements Parcelable {
    ...
    public WifiP2pDevice(String string) throws IllegalArgumentException {
    	 Log.e(TAG, "WifiP2pDevice string:" + string);
        ...
        switch (tokens.length) {
            ...
            default:
                ...
                if (match.group(9) != null) {
                    ...
                    wfdDeviceType =String.valueOf(wfdInfo.getDeviceType());
                    rtspPort = String.valueOf(wfdInfo.getControlPort());
                }
    ...
    void updateSupplicantDetails(WifiP2pDevice device) {
        ...
        wfdDeviceType = device.wfdDeviceType;
    ...
    public static final Creator<WifiP2pDevice> CREATOR =
        new Creator<WifiP2pDevice>() {
            public WifiP2pDevice createFromParcel(Parcel in) {
                ...
                device.wfdDeviceType = in.readString();
				        device.rtspPort = in.readString();
