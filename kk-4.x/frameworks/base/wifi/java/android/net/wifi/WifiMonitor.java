...
import android.net.wifi.p2p.WifiP2pWfdPort;
...
public class WifiMonitor {
    ...
    /* P2P_WFD_DEV_INFO 42:fc:89:a8:96:09 wfd_dev_info=0x0000060010216a000a */
    private static final String P2P_WFD_DEV_INFO = "P2P-WFD-DEV-INFO";
    ...
    private static final String AP_STA_CONNECTED_WFD_DEV_INFO_STR = "P2P-WFD-DEV-INFO";
   ...
   /* Network connection completed */
    ...
    public static final int ASSOCIATION_REJECTION_EVENT          = BASE + 43;
	 public static final int P2P_WFD_DEV_GO_NEGOTIATION_REQUEST_EVENT        = BASE + 44;
    public static final int P2P_WFD_DEV_PROV_DISC_REQUEST_EVENT          = BASE + 45;
    public static final int AP_STA_CONNECTED_WFD_DEV_EVENT       =BASE + 46;
    /**
...
//                m.mWifiNative.connectToSupplicant();
//                Log.d(TAG, "p2p MonitorThread start");
//                new MonitorThread(m.mWifiNative, this).start();
//            } else {
                if (DBG) Log.d(TAG, "connecting to supplicant");
                int connectTries = 0;
                while (true) {
                    if (m.mWifiNative.connectToSupplicant()) {
                        m.mMonitoring = true;
                        m.mWifiStateMachine.sendMessage(SUP_CONNECTION_EVENT);
                        Log.d(TAG, "wlan0 MonitorThread start");
                        new MonitorThread(m.mWifiNative, this).start();
                        mConnected = true;
                        break;
                    }
...
//            }
        ...
        public synchronized void registerInterfaceMonitor(String iface, WifiMonitor m) {
            ...
            if (mWifiNative == null) {
                ...
                Log.d(TAG, "registerInterface(mWifiNative" + m.mWifiNative);
            }
        }
    ...
    private static class MonitorThread extends Thread {
            ...
            for (;;) {
                ...
                if (eventStr.startsWith("IFNAME=")) {
                    ...
                    if (space != -1) {
                        ...
                        Log.d(TAG, "Event eventStr [" + eventStr + "]");
                    }
                } else {
                    Log.d(TAG, "Event [getMonitor]");
        ...
        private void handleP2pEvents(String dataString) {
            ...
            } else if (dataString.startsWith(P2P_WFD_DEV_INFO)) {
                mStateMachine.sendMessage(P2P_WFD_DEV_GO_NEGOTIATION_REQUEST_EVENT,
                        new WifiP2pWfdPort(dataString));
        ...
        private void handleHostApEvents(String dataString) {
            ...
            }else if(tokens[0].equals(AP_STA_CONNECTED_WFD_DEV_INFO_STR)){
            	 mStateMachine.sendMessage(P2P_WFD_DEV_GO_NEGOTIATION_REQUEST_EVENT, new WifiP2pWfdPort(dataString));
            }
        }
