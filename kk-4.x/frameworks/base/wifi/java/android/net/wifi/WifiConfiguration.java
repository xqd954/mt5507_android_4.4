...
public class WifiConfiguration implements Parcelable {
    ...
    public class EnterpriseField {
        ...
        public void setValue(String value) {
			...
			//zengyongying. to set value to new stuct
			if(enterpriseConfig == null) {
				return;
			}
			if(this.varName.equals("eap")) {
				int index = enterpriseConfig.getStringIndex(WifiEnterpriseConfig.Eap.strings,value,WifiEnterpriseConfig.Eap.NONE);
				enterpriseConfig.setEapMethod(index);
			}else if(this.varName.equals("phase2")) {
				int index = enterpriseConfig.getStringIndex(WifiEnterpriseConfig.Phase2.strings,value,WifiEnterpriseConfig.Phase2.NONE);
				enterpriseConfig.setPhase2Method(index);
			}if(this.varName.equals("ca_cert")) {
				enterpriseConfig.setCaCertificateAlias(value);
			}if(this.varName.equals("client_cert")) {
				enterpriseConfig.setClientCertificateAlias(value);
			}if(this.varName.equals("key_id")) {
				enterpriseConfig.setKeyIDValue(value);
			}if(this.varName.equals("identity")) {
				enterpriseConfig.setIdentity(value);
			}if(this.varName.equals("anonymous_identity")) {
				enterpriseConfig.setAnonymousIdentity(value);
			}if(this.varName.equals("password")) {
				enterpriseConfig.setPassword(value);
			}
        }
