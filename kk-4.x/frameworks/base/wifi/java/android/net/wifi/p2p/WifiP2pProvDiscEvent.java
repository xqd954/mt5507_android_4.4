...
public class WifiP2pProvDiscEvent {
    ...
    public static final int DEV_INFO    = 5;
    ...
    public WifiP2pProvDiscEvent(String string) throws IllegalArgumentException {
        ...
        else if (tokens[0].endsWith("DEV-INFO")) event = DEV_INFO;
        else throw new IllegalArgumentException("Malformed event " + string);


        device = new WifiP2pDevice();
        device.deviceAddress = tokens[1];
      //  String devinfo = tokens[2];
      //  device.rtspPort = String.valueOf(parseHex(devinfo.substring(devinfo.length()-9,devinfo.length()-5)));
    ...
    private int parseHex(String hexString) {
        ...
        try {
            ...
            Log.e("WifiP2pProvDiscEvent", "Failed to parse hex string " + hexString);
        }
        return num;
    }
