...
///////add by bin start
  ...
  /**
     * Broadcast intent action indicating that received the event P2P_GO_NEGOTIATION_REQUEST. F
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String MTK_WIFI_P2P_GO_NEGOTIATION_REQUEST_ACTION =
        "android.net.wifi.p2p.GO_NEGOTIATION_REQUEST";


     /**
     * Broadcast intent action indicating that p2p connect success. 
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String MTK_WIFI_P2P_CONNECT_SUCCESS_ACTION =
        "android.net.wifi.p2p.CONNECT_SUCCESS_ACTION";

/**
			 * Broadcast intent action indicating that p2p connect success. 
			 */
			@SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
			public static final String MTK_WIFI_P2P_GROUP_STARTED_ACTION =
				"android.net.wifi.p2p.WIFI_P2P_GROUP_STARTED_ACTION";

	 /**
			* Broadcast intent action indicating that as GC p2p connect success. 
			*/
		   @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
		   public static final String MTK_WIFI_P2P_AS_GC_CONNECT_SUCCESS_ACTION =
			   "android.net.wifi.p2p.AS_GC_CONNECT_SUCCESS_ACTION";
	 
		  /**
			* Broadcast intent action indicating that as GO p2p connect success. 
			*/
		   @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
		   public static final String MTK_WIFI_P2P_AS_GO_CONNECT_SUCCESS_ACTION =
			   "android.net.wifi.p2p.AS_GO_CONNECT_SUCCESS_ACTION";

		   /**
			* Broadcast intent action indicating that as GO p2p connect success. 
			*/
		   @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
		   public static final String MTK_WIFI_P2P_AS_GO_PORT_ACTION =
			   "android.net.wifi.p2p.AS_GO_PORT_ACTION";
	 /**
     * Broadcast intent action indicating that group removed. 
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String MTK_WIFI_P2P_GROUP_REMOVED_ACTION =
        "android.net.wifi.p2p.GROUP_REMOVED_ACTION";

public static final String MTK_EXTRA_WIFI_P2P_CONFIG= "wifiP2pConfig";

    public static final String MTK_EXTRA_WIFI_P2P_GROUP= "wifiP2pGroup";
	
    public static final String MTK_EXTRA_WIFI_P2P_INTERFACE_ADDRESS= "interface_address";
	
	public static final String MTK_EXTRA_WIFI_P2P_GROUP_STARTED= "group_started";
	
	 public static final String MTK_EXTRA_WIFI_P2P_PORT= "rtsp_port";
///// end
   ...
   public interface DnsSdTxtRecordListener {
	...
	/**
     * Mod the Group ssid or/and passward that Created by User
     *
     * This API is used by Wifip2psettings
     *
     * @return {@code true} if the operation succeeds else {@code false}
     */
    public boolean ConfigGroupInfo(String ssid,String passphase) {
        try {
            mService.ConfigGroupInfo(ssid,passphase);
            return true;
   ...
   /**
    ...
    public void createGroup(Channel c, ActionListener listener) {
        Log.d("WifiP2pManager","09207---createGroup, set restartgo =true");
        reStartGO(true);
        checkChannel(c);
	...
	*/
	...
	public void setMiracastEnable(boolean enable){
		 try {
            mService.setMiracastEnable(enable);
        } catch(RemoteException e) {
           // ignore
        }
	}
     ...
     * Get Peer Ip address.
     *
     * @return String is the ip address
     * @hide
     */
    public String getMtkPeerIpAddress(String mac,WifiP2pGroup mWifiP2pGroup) {
        try {
            return mService.getMtkPeerIpAddress(mac,mWifiP2pGroup);
        } catch (RemoteException e) {
            return null;
        }
    }
    ...
    public boolean mtkP2pGroupAdd(){
    	 try {
            return mService.mtkP2pGroupAdd();
        } catch (RemoteException e) {
            return false;
        }
    	}
    ...
    public void setMtkWfdSupport(boolean iswfd){
    	 try {
             mService.setMtkWfdSupport(iswfd);
        } catch (RemoteException e) {
        }
    	}
		 /**
    ...
    public boolean getMtkWfdSupport(){
         try {
            return mService.getMtkWfdSupport();
        } catch (RemoteException e) {
            return false;
        }
        }
