   ...
   /**
     ...
     */
	 public int wifiIsDongleIn() {
        try {
            return mService.wifiIsDongleIn();
        } catch (RemoteException e) {
            return -1;
        }
    }
     ...
     */
	 public int wifiIsDongleOut() {
        try {
            return mService.wifiIsDongleOut();
        } catch (RemoteException e) {
            return -1;
        }
    }
	   ...
	   /**
		   ...
		   */
		   public boolean startSupplicant(boolean p2pSupported) {
			  try {
				  return mService.startSupplicant(p2pSupported);
			  } catch (RemoteException e) {
				  //return -1;
				  return false;
			  }
    ...
    /**
		   ...
		   */
		   public boolean connectToSupplicant() {
			  try {
				  return mService.connectToSupplicant();
			  } catch (RemoteException e) {
				  //return -1;
				  return false;
			  }
