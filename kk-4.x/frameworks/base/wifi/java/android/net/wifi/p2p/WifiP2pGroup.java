...
public class WifiP2pGroup implements Parcelable {
    ...
    private int mNetId;
	/**
     * add for android box WFD.
     */

	public String mRtspPort;

	public String mWfdDeviceType;
    ...
    public WifiP2pGroup(String supplicantEvent) throws IllegalArgumentException {
        ...
        Log.d("WifiP2pGroup","supplicantEvent:"+supplicantEvent);
        if (tokens.length < 3) {
        ...
        if (tokens[0].startsWith("P2P-GROUP")) {
            ...
            String[] reasonValue = tokens[3].split("=");
			if(reasonValue[0].equals("reason")){
                if(reasonValue[1].equals("GROUP_READD")){
					mReason = true;
				}
			}
            ...
            for (String token : tokens) {
                ...
                if (nameValue[0].equals("persistent")) {
                 ...
                 if (nameValue[0].equals("rtsp_port")) {
                    mRtspPort= nameValue[1];
                    continue;
               }
               if (nameValue[0].equals("device_type")) {
                    mWfdDeviceType = nameValue[1];
                    continue;
               }
            }
        } else {
	...
	/** @hide */
    public void setIsGroupAdd(boolean isGoAdd) {
        mReason = isGoAdd;
    }
   ...
   /** @hide */
	...
	public String getRtspPort() {
	 ...
	 /** @hide */
    public void setWfdDeviceType(String wfdDeviceType) {
        mWfdDeviceType = wfdDeviceType;
    }

	
	public String getWfdDeviceType() {
		   return mWfdDeviceType;
	}
    ...
    public String toString() {
        ...
        sbuf.append("network: ").append(mNetworkName);
         sbuf.append("\n RtspPort: ").append(mRtspPort);
		sbuf.append("\n WfdDeviceType: ").append(mWfdDeviceType);
    ...
    public WifiP2pGroup(WifiP2pGroup source) {
        if (source != null) {
            ...
            mNetId = source.getNetworkId();
               mWfdDeviceType = source.getWfdDeviceType();
			mRtspPort = source.getRtspPort();
        }
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
		...
		dest.writeByte(mReason ? (byte) 1: (byte) 0);
        ...
        dest.writeInt(mNetId);
        	dest.writeString(mWfdDeviceType);
		dest.writeString(mRtspPort);
    }
    ...
    public static final Creator<WifiP2pGroup> CREATOR =
        new Creator<WifiP2pGroup>() {
            public WifiP2pGroup createFromParcel(Parcel in) {
				...
				group.setIsGroupAdd(in.readByte() == (byte)1);
                ...
                group.setNetworkId(in.readInt());
                		group.setWfdDeviceType(in.readString());
				group.setRtspPort(in.readString());
                return group;
            }
