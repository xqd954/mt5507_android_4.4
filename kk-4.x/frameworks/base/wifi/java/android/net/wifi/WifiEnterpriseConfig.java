...
public class WifiEnterpriseConfig implements Parcelable {
     ...
     */
    public int getStringIndex(String arr[], String toBeFound, int defaultIndex) {
    ...
    //zengyongying
    public void setKeyIDValue(String value) {
    	setFieldValue(PRIVATE_KEY_ID_KEY, value, Credentials.USER_PRIVATE_KEY);
    }
