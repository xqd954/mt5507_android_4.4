...
static void android_media_MediaScanner_enableScan(
...
static void android_media_MediaScanner_disableScan(
        JNIEnv *env, jobject thiz)
{
    ALOGV("-----disableScan-----");
    MediaScanner *mp = getNativeScanner_l(env, thiz);
...
static JNINativeMethod gMethods[] = {
	//Added by zhaojun for mediascan start/stop
	{
		"enableScan",
		"()V",
		(void *)android_media_MediaScanner_enableScan
	},
	{
		"disableScan",
		"()V",
		(void *)android_media_MediaScanner_disableScan
	},
	//Add end
