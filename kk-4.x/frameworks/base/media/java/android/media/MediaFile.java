...
public class MediaFile {
    ...
    public static final int FILE_TYPE_AES     = 12;
    private static final int FIRST_AUDIO_FILE_TYPE = FILE_TYPE_MP3;
    private static final int LAST_AUDIO_FILE_TYPE = FILE_TYPE_AES;
    ...
    public static final int FILE_TYPE_FLV     = 29;
    public static final int FILE_TYPE_MKV     = 30;
    public static final int FILE_TYPE_RM      = 31;
    public static final int FILE_TYPE_PS      = 32;
    public static final int FILE_TYPE_TS      = 33;
    public static final int FILE_TYPE_VES     = 34;
    public static final int FILE_TYPE_MP2TS   = 35;
    public static final int FILE_TYPE_WEBM    = 36;
    public static final int FILE_TYPE_MOV     = 37;
    ...
    static {
        ...
        addFileType("AC3", FILE_TYPE_AES, "audio/aes");
 	addFileType("EC3", FILE_TYPE_AES, "audio/aes");
	addFileType("AIF", FILE_TYPE_AES, "audio/aes");
	addFileType("WMA", FILE_TYPE_AES, "audio/aes");
	addFileType("RA", FILE_TYPE_AES, "audio/aes");
	...
	addFileType("MKA", FILE_TYPE_MKV, "video/mkv");
	addFileType("MKS", FILE_TYPE_MKV, "video/mkv");
	addFileType("WEBM", FILE_TYPE_MKV, "video/mkv");
	addFileType("RM", FILE_TYPE_RM, "video/rmvb");
	addFileType("RMVB", FILE_TYPE_RM, "video/rmvb");
	addFileType("RAM", FILE_TYPE_RM, "video/rmvb");
	addFileType("MPG", FILE_TYPE_PS, "video/ps");
	//addFileType("MPEG", FILE_TYPE_PS, "video/ps");
	addFileType("DAT", FILE_TYPE_PS, "video/ps");
	addFileType("VOB", FILE_TYPE_PS, "video/ps");
	addFileType("MLV", FILE_TYPE_PS, "video/ps");
	addFileType("TS", FILE_TYPE_TS, "video/ts");
	addFileType("M2TS", FILE_TYPE_TS, "video/m2ts");
	addFileType("MTS", FILE_TYPE_TS, "video/mts");
	addFileType("PVR", FILE_TYPE_TS, "video/mts");
	addFileType("TP", FILE_TYPE_TS, "video/mts");
	addFileType("AVS", FILE_TYPE_VES, "video/ves");
	addFileType("M2V", FILE_TYPE_VES, "video/ves");
	//addFileType("M4V", FILE_TYPE_VES, "video/ves");
	addFileType("264", FILE_TYPE_VES, "video/ves");
	addFileType("VC1", FILE_TYPE_VES, "video/ves");
