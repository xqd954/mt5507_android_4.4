...
int lookup_keyword(const char *s)
{
    ...
    case 'i':
        ...
        if (!strcmp(s, "nsmod_async")) return K_insmod_async;
    ...
    case 's':
        ...
        if (!strcmp(s, "ystem")) return K_system;
        break;
    case 't':
    ...
    case 'u':
        ...
        break;
    case 'w':
        if (!strcmp(s, "aitlock")) return K_waitlock;
        if (!strcmp(s, "rite")) return K_write;
        if (!strcmp(s, "rite_symlink")) return K_write_symlink;
