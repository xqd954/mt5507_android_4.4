...
static char console_name[PROP_VALUE_MAX] = "/dev/ttyMT0";
...
static void addBootTimeStamp(const char *pMsg)
{
	// TOOD: use property
	...
	{
		ERROR("********%s: open file NG", __FUNCTION__);	
	}
}
#endif
...
void service_start(struct service *svc, const char *dynamic_args)
{
    ...
    {
        char tmpStr[64];
        sprintf(tmpStr, "init: '%s' started", svc->name);
        addBootTimeStamp(tmpStr);
    }
#endif
