...
//add by gdw.
//#ifdef ALLOW_ADBD_ROOT_FOR_DEBUG
    char debugValue[PROPERTY_VALUE_MAX];
    property_get("debug.service.adb.root",debugValue,"");    
    ...
    */
    ...
    if (strcmp(value, "1") != 0) {
        ...
        if (strcmp(value, "1") == 0) {
            ...
            property_get("ro.debuggable", value, "");
            if (strcmp(value, "1") == 0) {
                property_get("debug.service.adb.root", value, "");
                if (strcmp(value, "1") == 0) {
                    secure = 0;
                }
            }
