...
#ifndef __BT_COMMON_CONFIG_H
#define __BT_COMMON_CONFIG_H

//VIRTUAL_PORTS_NUM will be defined in make file and option.mak

#define VIRTUAL_PORTS_NUM   9
...
#define NUM_SPP_CLIENTS 3



#endif /* __BT_COMMON_CONFIG_H */ 
