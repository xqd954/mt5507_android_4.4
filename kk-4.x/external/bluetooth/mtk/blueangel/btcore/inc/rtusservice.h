...
typedef struct _BtRtusServiceCbHandler
{
    ListEntry node;         	/* For internal stack use only. */
    AttdbCallback callback;    /* Pointer to callback function */
} BtRtusServiceCbHandler;

typedef struct _BleRtus_T
{
    U8 registerCount;
    BtRtusServiceCbHandler RtusUpdateControlPointList;
    BtRtusServiceCbHandler RtusUpdateStateList;
