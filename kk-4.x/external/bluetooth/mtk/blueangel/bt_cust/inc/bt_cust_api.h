 ...
 *==============================================================================
 *******************************************************************************/
#ifndef __BT_CUST_API_H__
#define __BT_CUST_API_H__
...
/*
int getCustInt(BT_CUST_ID cid);

const char *getCustStr(BT_CUST_ID cid);

int getDevCustInt(BT_DEVICE_ID did, BT_CUST_ID cid);

const char *getDevCustStr(BT_DEVICE_ID did, BT_CUST_ID cid);
*/
#endif /* __BT_CUST_API_H__ */
