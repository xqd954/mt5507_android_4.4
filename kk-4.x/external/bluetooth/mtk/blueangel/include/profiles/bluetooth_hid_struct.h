...
#define	POINTER_Z_USAGE	0x32
#define	POINTER_RX_USAGE	0x33
#define	POINTER_RY_USAGE	0x34
#define	POINTER_RZ_USAGE	0x35
#define	WHEEL_USAGE	0x38
#define	HAT_USAGE	0x39
...
typedef bt_hidd_activate_cnf_struct bt_hidh_activate_cnf_struct;
...
typedef bt_hidd_deactivate_cnf_struct bt_hidh_deactivate_cnf_struct;
...
typedef bt_hidd_connect_req_struct bt_hidh_connect_req_struct;
...
typedef bt_hidd_connect_cnf_struct bt_hidh_connect_cnf_struct;
...
typedef bt_hidd_query_req_struct bt_hidh_query_req_struct;
...
typedef bt_hidd_query_cnf_struct bt_hidh_query_cnf_struct;
...
typedef bt_hidd_connect_ind_struct bt_hidh_connect_ind_struct;
...
typedef bt_hidd_connection_authorize_ind_struct bt_hidh_connection_authorize_ind_struct;
...
typedef bt_hidd_connection_authorize_rsp_struct bt_hidh_connection_authorize_rsp_struct;
...
typedef bt_hidd_disconnect_req_struct bt_hidh_disconnect_req_struct;
...
typedef bt_hidd_disconnect_cnf_struct bt_hidh_disconnect_cnf_struct;
...
typedef bt_hidd_disconnect_ind_struct bt_hidh_disconnect_ind_struct;
...
typedef bt_hidd_unplug_cnf_struct bt_hidh_unplug_cnf_struct;
...
typedef bt_hidd_control_req_struct bt_hidh_control_req_struct;
...
typedef bt_hidd_control_ind_struct bt_hidh_control_ind_struct;
...
typedef bt_hidd_interrupt_data_cnf_struct bt_hidh_interrupt_data_cnf_struct;
