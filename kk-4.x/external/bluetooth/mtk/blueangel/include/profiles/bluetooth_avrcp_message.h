...
enum 
{
   ...
   MSG_ID_BT_AVRCP_SDP_QUERY_IND,
   MSG_ID_BT_AVRCP_RESERVED_3, // for new MSG_ID
   MSG_ID_BT_AVRCP_RESERVED_4, // for new MSG_ID
   MSG_ID_BT_AVRCP_RESERVED_5, // for new MSG_ID
   MSG_ID_BT_AVRCP_RESERVED_6, // for new MSG_ID
   MSG_ID_BT_AVRCP_RESERVED_7, // for new MSG_ID
   MSG_ID_BT_AVRCP_TEST_CMD_REQ, // for new MSG_ID
   MSG_ID_BT_AVRCP_RESERVED_9, // for new MSG_ID
   MSG_ID_BT_AVRCP_RESERVED_10, // for new MSG_ID   
   MSG_ID_BT_AVRCP_GROUP_END = MSG_ID_BT_AVRCP_RESERVED_10,
#ifdef SOURCE_INSIGHT_TRACE
};
#endif
#endif
