 ...
 * HfgDiscReason type
 */
typedef U8 HfgDiscReason;
    
#define HFG_DISCREASON_NORMAL          0x00   /* No error */
#define HFG_DISCREASON_ACL_CONN        0x01   /* ACL connection failed */
#define HFG_DISCREASON_ACL_DISC        0x02   /* ACL is disconnected before RFCOMM disconnect */
#define HFG_DISCREASON_SDP             0x03   /* SDP query failed or find no service */
#define HFG_DISCREASON_RFCOMM          0x04   /* RFCOMM connection failed */
...
/* Supports Version 1.6 of the Hands Free Profile */
#define HFG_HF_VERSION_1_6     0x0106
/*--------------------------------------------------------------------------
