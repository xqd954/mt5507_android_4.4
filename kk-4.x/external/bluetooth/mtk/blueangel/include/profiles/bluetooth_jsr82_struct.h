...
#define JSR82_SESSION_COMMON_SUCCESS	(0x01)
#define JSR82_SESSION_COMMON_FAIL		(0x02)
...
#define JBT_LIST_SEARCH_TYPE_BY_SESSION_ID 3
...
typedef struct {
    U8 address[6];
} /*__attribute__((packed))*/bt_bdaddr;
...
typedef struct {
    ...
    int channel;
    int status;
} /*__attribute__((packed)) */connection_signal;
