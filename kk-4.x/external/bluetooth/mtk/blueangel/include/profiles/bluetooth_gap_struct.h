 ...
 * $Log$
 *
 * 12 11 2013 liang.cheng
 * [ALPS01263779] [PBAP]when receive PBAP request ,phone JE
 * sync stack&gap external layer max paired device num as 40.
 *
 * 12 09 2013 liang.cheng
 * [ALPS01193741] [KK][BT][Migration]Souce code check in
 * check in dynamic enable/disable hcisnoop log.
 *
 * 11 28 2013 liang.cheng
 * [ALPS01238080] [SQC0][MT6582][KK]NE happen and BT auto off, cannot turn on again when rename BT too long to save
 * 	modify max name length as 249(248 byte + 1byte).
 *
