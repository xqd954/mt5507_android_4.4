 ...
 *==============================================================================
 *******************************************************************************/
#ifndef __BT_ADP_MSG_H__
#define __BT_ADP_MSG_H__

void BTCoreSendNotifySelfMessage(void);
#ifdef BTMTK_ON_WISE 
#define BT_SendMessage(msg, dest_mod, local_para, size) bt_send_msg(msg, dest_mod, NULL, local_para, NULL)
#else   /* BTMTK_ON_WISE */
