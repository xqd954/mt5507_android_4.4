 ...
 *
 * Nov 5 2008 mbj06041
 * [MAUI_01243089] MMS, Email: Defect about incorrect display of vcard name
 * 
 *
 * Apr 16 2008 mbj06041
 * [MAUI_00755145] qprint encode algorithm has memory overflow problem
 * 
 *
 * Dec 3 2007 mbj06041
 * [MAUI_00498770] [Email] New feature check-in: Email over SSL/TLS.
 * 
 *
 * Aug 10 2007 mbj06041
 * [MAUI_00458292] new applib BASE64 / QP checkin
 * 
 *
 * Jan 9 2006 mtk00435
 * [MAUI_00166880] Remove compile warning in applib_qprint_encode_ext()
 * 
 *
 * Dec 18 2005 mtk00584
 * [MAUI_00217909] To Do list_the Note will be change
 * 
 *
 *------------------------------------------------------------------------------
            ...
            kal_int32 dstl)
{
    ...
    memcpy(dst+i_output,buf,cnt);
    i_output += cnt;
    if (QP_NEED_AUTO_WRAP)
    {
        cntx->line_cnt += (U8)cnt;
    }
