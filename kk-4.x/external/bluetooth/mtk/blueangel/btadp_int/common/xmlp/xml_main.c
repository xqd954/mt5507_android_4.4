...
*------------------------------------------------------------------------------
* $Revision: #1 $
* $Modtime:   Jul 19 2005 10:35:10  $
* $Log:   //mtkvs01/vmdata/Maui_sw/archives/mcu/xmlp/src/xml_main.c-arc  $
 *
 * 04 19 2011 sh.lai
 * [ALPS00143645] [Android Build Warning Issue] mediatek/source/external/bluetooth/blueangel/btadp_int/common/xmlp/xml_main.c
 * .
 *
 * Feb 17 2009 mtk80203
 * [MAUI_01315798] [BC] MS will stay at parsing screen all the time
 * 
 *
 * Jan 15 2009 mtk80203
 * [MAUI_01315798] [BC] MS will stay at parsing screen all the time
 * 
 *
 * Dec 23 2008 mbj08033
 * [MAUI_01355418] [udx]the email address have not added when paring
 * 
 *
 ...
 *
 * Dec 9 2008 mbj08033
 * [MAUI_01348552] [udx] cannot parsing a .udx file when the email address first character  have space
 * 
 *
 ...
 *
 * Nov 28 2008 mbj08033
 * [MAUI_01340117] [udx]the contact name is changed after parse
 * 
 *
 * Nov 28 2008 mbj08033
 * [MAUI_01343624] [udx]always show 0% in parsing screen
 * 
 *
 ...
 *
 * Sep 4 2008 mbj08033
 * [MAUI_01110953] xml enhancement
 * 
 *
 * Jul 25 2008 mbj08033
 * [MAUI_01095657] Xml temp file modify
 * 
 *
 * May 16 2008 mbj06034
 * [MAUI_00976686] MTK:Bluetooth BIP_[1] Fatal Error (207, 26f3990) - BT
 * Reduce stack usage
 *
 * Apr 1 2008 mbj06034
 * [MAUI_00649904] [xml parser] for memory leak
 * patch for memory leak in entity replacement
 *
 * Dec 13 2007 mbj06066
 * [MAUI_00503916] return PARSER STRUCT to application when callback
 * 
 *
 * Nov 29 2007 mbj06066
 * [MAUI_00494762] XML PARSER modify for cdata
 * if data is only cdata, call xml_process_cdata
 *
 * Nov 28 2007 mbj06066
 * [MAUI_00494762] XML PARSER modify for cdata
 * large cdata over 2k for syncml
 *
 * Nov 22 2007 mbj06066
 * [MAUI_00494762] XML PARSER modify for cdata
 * xml_main.c modify for comment
 *
 * Nov 19 2007 mbj06066
 * [MAUI_00494762] XML PARSER modify for cdata
 * 
 *
 ...
 *
 * Nov 8 2007 mbj06066
 * [MAUI_00491023] xml parser modify for if (parser->stop == 0)
 * 
 *
 * Oct 30 2007 MBJ06066
 * [MAUI_00047832] Fatal Error: Buffer not available 1 =804 2=8 - MMI
 * 
 *
 * Oct 19 2007 MBJ06066
 * [MAUI_00239280] Fatal Error (305): msg_send_ext_queue() failed (88880026) - L4
 * 
 *
 * Aug 31 2007 MBJ06066
 * [MAUI_00237546] Fatal Error (804): Buffer not available (800) - MMI
 * 
 *
 * Jun 27 2007 MBJ06066
 * [MAUI_00234736] [1] Fatal Error (305): msg_send_ext_queue() failed (88880026) - L4
 * 
 *
 * Jun 27 2007 MBJ06066
 * [MAUI_00234736] [1] Fatal Error (305): msg_send_ext_queue() failed (88880026) - L4
 ...
 *
 * Jun 4 2007 MBJ06066
 * [MAUI_00434917] [Slide Show] [1] Assert fail: ADM_MB_STATE(adm_mb_head) == ADM_INUSE kal_adm.c 652 -
 * updata function xml_save_content_data
 *
 * May 14 2007 mtk00911
 * [MAUI_00392080] [DRM][New Feature] 2.0 Support
 * 
 *
 * May 8 2007 MBJ06066
 * [MAUI_00232817] [1] Assert fail: ADM_MB_STATE(adm_mb_head) == ADM_INUSE kal_adm.c 652 0x0 0x0 0x0 -
 * update process_start_tag : handling entity replacement if entity reference is exsit
 *
 ...
 * Apr 23 2007 MBJ06066
 * [MAUI_00425257] xmlp enhancement
 * xmlp enhancement: entity, cdata, error report, xml_parse_buffer
*
* Feb 26 2007 mtk00418
* [MAUI_00368078] [BugFix][XMLP] long data content length mismatch
* 
*
* Feb 12 2007 mtk00418
* [MAUI_00229757] [Jataayu MMS]_It display a SVG file in content
* 
*
...
*
* Oct 4 2006 mtk00418
* [MAUI_00333482] Bluetooth_ The file name and type is incorrect on file browser list when connect Nok
* 
*
* Sep 9 2006 mtk00418
* [MAUI_00328508] [FeatureChange] reduce XML parser stack size
* 
*
* Jul 31 2006 mtk00418
* [MAUI_00223949] [1] Fatal Error (305): msg_send_ext_queue() failed - L4
* 
*
* Jul 27 2006 mtk00418
...
* 
*
* Apr 10 2006 mtk00418
* [MAUI_00177191] [DLT] PMT Patch 2006/02/27~
* 
*
* Mar 21 2006 mtk00418
* [MAUI_00181126] [BT] Can't browse the file via FTP profile
* 
*
...
* 
*
* Oct 12 2005 mtk00418
* [MAUI_00126877] [RemoveWarning] remove compile warning
* 
*
* Sep 23 2005 mtk00418
* [MAUI_00216786] Fatal Error (807): Release size 0 buffer to pool - IMPS
* 
*
* Sep 13 2005 mtk00563
* [MAUI_00123437] [MMI]Remove compile warnings.
* 
* 
*    Rev 1.14   Jul 19 2005 10:37:40   mtk00563
* Add for DLT (DownLoadable Theme)
* Resolution for 11995: [MMI][GUI] Add for DLT
* 
*    Rev 1.13   May 27 2005 16:05:40   mtk00418
* include ;
* Resolution for 10406: [NewFeature][XMLP] support special character pattern
* 
*    Rev 1.12   May 21 2005 13:46:48   mtk00418
* add EOF check
* Resolution for 11157: [BugFix][XMLP]handle incomplete tag
* 
*    Rev 1.11   May 17 2005 03:08:14   BM_Trunk
* Karlos:
* add copyright and disclaimer statement
* 
*    Rev 1.10   May 09 2005 09:47:36   mtk00418
* fix memory leak
* Resolution for 9999: [NewFeature][XMLP]save large data to file
* 
*    Rev 1.9   Apr 29 2005 21:25:04   mtk00418
* large data always use file
* Resolution for 9999: [NewFeature][XMLP]save large data to file
* 
*    Rev 1.8   Apr 25 2005 11:29:00   mtk00418
* reduce max read data length to 2047 to accomadate null terminate char
* Resolution for 9999: [NewFeature][XMLP]save large data to file
* 
*    Rev 1.7   Apr 19 2005 15:28:40   mtk00418
* fix compile error
* Resolution for 10405: [BugFix][APPMEM] check fail case when get ASM fail
* 
*    Rev 1.6   Mar 27 2005 11:59:40   mtk00418
* support special characters
* Resolution for 10406: [NewFeature][XMLP] support special character pattern
* 
*    Rev 1.5   Mar 06 2005 11:10:06   mtk00418
* file length counter will overflow, change to signed integer
* Resolution for 9999: [NewFeature][XMLP]save large data to file
* 
*    Rev 1.4   Feb 25 2005 17:36:22   mtk00418
* store large data to file
* Resolution for 9999: [NewFeature][XMLP]save large data to file
* 
*    Rev 1.3   Feb 21 2005 10:45:24   mtk00418
* add start tag valid check function
* Resolution for 9893: [BugFix][XMLP]fix compile error
* 
...
// from stdio.h SetFilePointer of win32 api
// ETODO
...
static kal_bool xml_init_folder(void);
...
static kal_int32 xml_scan_named_char(XML_PARSER_STRUCT *parser, FHANDLE *handle, 
...
static void xml_get_entity_value(
                                    ...
                                    kal_char *start, 
                                    kal_char *end);
static void xml_save_content_data(XML_PARSER_STRUCT * parser,FHANDLE *handle, 
...
static kal_int32 xml_read_xmltext(
                            ...
                            kal_int32 size,
                            int*length);
static kal_int32 xml_seek_xmltext(XML_PARSER_STRUCT *parser, kal_int32 offset, btmtk_seek_mode_enum ref);
static kal_int32 xml_get_curr_position(XML_PARSER_STRUCT *parser);


/* utility */
#define __XML_UNITTEST_PC__ 1 // DAY: Test

#if 0
static const kal_char *xml_convert_named_char(kal_char ch);
#endif
 ...
 *  void
 *****************************************************************************/
static kal_int32 vir_seek_file(XML_PARSER_STRUCT *parser, kal_int32 offset, kal_int32 ref)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
static kal_int32 vir_read_file(XML_PARSER_STRUCT *parser, void * buf, kal_uint32 size, kal_uint32* len)
{
#if 0
   /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	virtual_file_buf_struct *fileptr;
	kal_int32  ret, reserdatalen, readlen;
		...
		*len = size;
		...
		{   
		    if ((fileptr->virfilelen == 0) && (fileptr->realfileseekpos == 0))
		    {
		    	...
		    	ret = DRM_read_file(fileptr->fp, fileptr->bufptr, fileptr->bufsize, (kal_uint32*)&readlen);
#else
				Assert(0);
				ret = 0;
#endif
	    ...
	    else
	    {
			...
			//	                fileptr->bufsize - FILEBUF_BACKSIZE, (kal_uint32*)&readlen);
...
//    FHANDLE fh;
    ...
    // fh = btmtk_fs_open_rstream((kal_uint16*)L"Z:\\@Xml\\", FS_READ_ONLY | FS_OPEN_DIR);
    // fh = btmtk_fs_is_folder_exist(CONST_XML_FOLDER);

    //if (fh >= FHANDLE_INVALID_VALUE)
	if( FALSE != btmtk_fs_is_dir_exist_ucs2(CONST_XML_FOLDER) )
    {
        //kal_prompt_trace(MOD_MMI, "[XML] xml folder exsit");
        
    }
    else
    {
        //ret = FS_CreateDir((kal_uint16*)L"Z:\\@Xml\\");
	    ret = btmtk_fs_create_dir_ucs2( CONST_XML_FOLDER );

        if (ret < 0)
        {
            //kal_prompt_trace(MOD_MMI, "[XML] xml creat folder failed");
            /*
            In terminal server, some driver is not available,
            then we do not think it failure.
            the only defect is that can not parse tag data biger than MAX_CTRL_BUFFER_SIZE
            zhigang yu/2009-12-10
 ...
 *  xml_init_virfile
 * DESCRIPTION
 *  this function is used to init new parser
 * PARAMETERS
 *  parser      [IN]        Global parser struct
 *  
 * RETURNS
 *  result of parser
 *****************************************************************************/
void  xml_init_virfile(XML_PARSER_STRUCT *parser, kal_char* buffer, kal_int32 size)
{
    virtual_file_buf_struct *virfileptr;

    virfileptr = &(parser->virfileptr);
	virfileptr->bufptr = buffer;
	virfileptr->valid = 1;
    virfileptr->isfull = 0;
    virfileptr->realfilebeginpos = 0;
	virfileptr->realfileseekpos = 0;
    virfileptr->virfilelen = 0;
	virfileptr->virfileseek = 0;
	virfileptr->bufsize = size;
}
 ...
 *  result of parser
 *****************************************************************************/
kal_int32 xml_new_parser_ext(XML_PARSER_STRUCT *parser, kal_char* buffer, kal_int32 size)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    if (parser != NULL)
    {
        ...
        xml_init_virfile(parser, buffer, size);
...
void xml_close_parser(XML_PARSER_STRUCT *parser)
{
    ...
    if (parser != NULL)
    {
        ...
        if (parser->source != FHANDLE_INVALID_VALUE)
        {
            //btmtk_fs_close_rstream(parser->source);
	    btmtk_fs_close_ucs2(parser->source);
            parser->source = FHANDLE_INVALID_VALUE;
        }
 ...
 *  void
 *****************************************************************************/
kal_int32 xml_parse(XML_PARSER_STRUCT *parser, U8 *file_name)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    //parser->source = DRM_open_file(file_name, FS_READ_ONLY, DRM_PERMISSION_NONE);
	parser->source = btmtk_fs_open_ucs2( (U16*)file_name , BTMTK_FS_READ_ONLY);
    ...
    parser->virfileptr.fp = parser->source;
	...
	//kal_prompt_trace(MOD_MMI, "we have finished prolog parse!\r\n");
	//kal_prompt_trace(MOD_MMI, "the result is %d", result);
    /* 2. parse element */
 ...
 * PARAMETERS
 *  parser          [IN/OUT]        Global parser struct
 *  file_handle     [IN]            FHANDLE of xml file
 * RETURNS
 *  void
 *****************************************************************************/
kal_int32 xml_parse_file_from_offset(XML_PARSER_STRUCT *parser, kal_int32 file_handle)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    parser->source = file_handle;   /* btmtk_fs_open_rstream ((WCHAR*)tmp_filename, FS_READ_ONLY); */
...
void xml_stop_parse(XML_PARSER_STRUCT *parser)
{
    ...
    count = (parser->ge_count > XML_MAX_ENTITY_COUNT) ? XML_MAX_ENTITY_COUNT : parser->ge_count;
    for (i = 0; i < count; i++)
    {
        free_buffer(parser, parser->ge_data[i << 1]);
        free_buffer(parser, parser->ge_data[(i << 1) + 1]);
    ...
    count = (parser->pe_count > XML_MAX_ENTITY_COUNT) ? XML_MAX_ENTITY_COUNT : parser->pe_count;
    for (i = 0; i < count; i++)
    {
        free_buffer(parser, parser->pe_data[i << 1]);
        free_buffer(parser, parser->pe_data[(i << 1) + 1]);
...
static kal_int32 xml_parse_prolog(XML_PARSER_STRUCT *parser)
{
    ...
    //kal_prompt_trace(MOD_MMI,"we have get buffer for parser!\r\n");
    while ((parser->stop == 0)  &&
           (parser->pause == 0) && 
           (xml_read_xmltext(parser, buffer, parser->pos, XML_BUFFER_LENGTH - 1, &len) == BTMTK_FS_OK))
    {
        if (len == 0 || len == back_len)
            break;  /* go to the end of xml file */
		//kal_prompt_trace(MOD_MMI, "the length of data read is %d", len);
        ...
        if ((temp != NULL) && (!(ptr_start != NULL && ptr_start < temp)))
        {
            ...
            if (temp == ptr_doc)
            {
                ...
                if (ptr_end != NULL)
                {
                    ...
                    parser->pos += ptr_end - ptr + 1;
                    ptr = ptr_end + 1;
                    ret = xml_seek_xmltext(parser, parser->pos, BTMTK_FS_SEEK_BEGIN);
                    if (ret < 0)
                    {
                        xml_free_buffer(parser, buffer);
                        return XML_RESULT_FAIL;
        ...
        else
        {
            ...
            if (parser->pos == 0 &&
                    ((ptr[0] == (kal_char)0xff && ptr[1] == (kal_char)0xfe) ||
                    (ptr[0] == (kal_char)0xfe && ptr[1] == (kal_char)0xff)))
            {
...
static kal_int32 xml_parse_element(XML_PARSER_STRUCT *parser)
{
    ...
    while ((parser->stop == 0) &&
           (parser->pause == 0) && 
           (xml_read_xmltext(parser, buffer, parser->pos, XML_BUFFER_LENGTH - 1, &len) == 0 ))
    {
        if (len == 0 || len == back_len)
...
static kal_int32 xml_process_prolog(XML_PARSER_STRUCT *parser, kal_int32 start, kal_int32 length)
{
    ...
    free_buffer(parser, temp);
    xml_seek_xmltext(parser, fp, BTMTK_FS_SEEK_BEGIN);
	//*((int*)0) = *((int*)0); //DAY: Test
...
static kal_int32 xml_process_data(XML_PARSER_STRUCT *parser, kal_int32 length)
{
    ...
    {
        btmtk_fs_close_ucs2(handle);
        parser->data_hdlr(parser, parser->elem[parser->curr_depth-1], (kal_char*)L"Z:\\@Xml\\xml_temp", 0, parser->error);
    }
 ...
 static kal_int32 xml_process_cdata(XML_PARSER_STRUCT *parser, kal_int32 length)
{
    ...
    kal_uint32 fp, position;
    kal_int32 ret, i = 0;
    FHANDLE handle = FHANDLE_INVALID_VALUE;
    ...
    if (i >=  (MAX_CTRL_BUFFER_SIZE-1))
    {
        handle = btmtk_fs_open_ucs2((U16*)L"d:\\temp\\ftp\\xmlcdata.txt", BTMTK_FS_READ_WRITE | BTMTK_FS_CREATE_ALWAYS);
        if (handle < 0)
        {
                free_buffer(parser, parser->ap_temp);
                parser->ap_temp = NULL;
    ...
    while (i > 0)   /* i is used as the rest length of content data */
    {
        ...
        ret = btmtk_fs_write_ucs2(handle, parser->ap_temp, len_read, (S32*)&len_write);
        if (ret < 0)
        {
            free_buffer(parser, parser->ap_temp);
            parser->ap_temp = NULL;
...
/*****************************************************************************
 * FUNCTION
 *  xml_convert_named_char
 * DESCRIPTION
 *  this function is used to convert named_char
 * PARAMETERS
 *  ch      [IN]        Char to be converted
 * RETURNS
 *  return named_string
 *****************************************************************************/
static const kal_char *xml_convert_named_char(kal_char ch)
{
    ...
    {
        if (ch == xml_named_char_table[i].named_ch)
        {
            return xml_named_char_table[i].named_string;
        }
    }
    return NULL;
}
 ...
 *****************************************************************************/
static kal_int32 xml_convert_entity_value(kal_uint32 value, kal_char *data, kal_int32 length)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    kal_int32 i = 0, len = 0;
    kal_char temp_buf[XML_CHAR_ENTITY_LENGTH];
    ...
    while (value)
    {
        temp_buf[i++] = (kal_char)(value & 0xFF);
        value = value >> 8;
    ...
    {
        memcpy(&data[len], (kal_char*)(&value), 1);
    }
                ...
                kal_int32 len_data)
{
    ...
    if ((*dest == NULL) && (*handle != 0))
        btmtk_fs_write_ucs2(*handle, (void*)data, len_data, &len);
    else
    {
        ...
        {
            *handle = btmtk_fs_open_ucs2(L"d:\\temp\\ftp\\xml_temp", BTMTK_FS_READ_WRITE | BTMTK_FS_CREATE_ALWAYS);
            btmtk_fs_write_ucs2(*handle, (void*)*dest, len_dest, &len);
            btmtk_fs_write_ucs2(*handle, (void*)data, len_data, &len);
                            ...
                            int*length)
{
    ...
    if (parser->source != 0)
    {
       if(parser->isext == 0)
       {
        ...
        //if (ret < 0)
            if( from != btmtk_fs_seek_ucs2(parser->source, from, BTMTK_FS_SEEK_BEGIN) )
        {
            return XML_RESULT_FILE_NOT_FOUND;
        }
	//ret = DRM_read_file(parser->source, buffer, size, (kal_uint32*)length); 
            ret = btmtk_fs_read_ucs2(parser->source, buffer, size, (S32 *)length);
       
            if (ret != BTMTK_FS_OK) //FS_MSDC_READ_SECTOR_ERROR)
	{
	    return XML_RESULT_FILE_NOT_FOUND;
        }
	else return ret;
    ...
    else
    {
            ...
            return vir_read_file(parser, buffer, size, (kal_uint32*)length);
       }
    }
    else
    {
...
static kal_int32 xml_seek_xmltext(XML_PARSER_STRUCT *parser, kal_int32 offset, btmtk_seek_mode_enum ref)
{
    ...
    if (parser->source != 0)
    {
        if(parser->isext != 0)
        {
	        return vir_seek_file(parser, offset, (kal_uint8)ref);
        }
        else
        {
			//*((int*)0) = *((int*)0); // DAY: test
            return btmtk_fs_seek_ucs2(parser->source, offset, ref);
...
{   
    ...
    if (parser->source != 0)
    {
        ...
        btmtk_fs_get_position_ucs2(parser->source, &pos);
        return pos;
    }
    else
        return 0;
...
void test_xml_elem_start_hdlr(void *data, const kal_char *el, const kal_char **attr, kal_int32 error)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    btmtk_fs_write_wstream(result, el_info, strlen(el_info), (kal_uint32*)&length);
...
void test_xml_elem_end_hdlr(void *data, const kal_char *el, kal_int32 error)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    btmtk_fs_write_wstream(result, endtag, strlen(endtag), (kal_uint32*)&length);
}

void test_xml_general_data_hdlr(void *resv, const kal_char *el, const kal_char *data, kal_int32 len, kal_int32 error)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    if(error != 0)
    {
        kal_char err_info[100];

        memset(err_info, 0, 100);
        err_str = xml_get_err_string(&parser);
        kal_wsprintf((kal_uint16*)err_info, "error string in %s data: %s\r\n", el, err_str);
        //kal_prompt_trace(MOD_MMI, err_info);
        btmtk_fs_write_wstream(result, err_info, strlen(err_info), (kal_uint32*)&length);    
    }
    //kal_prompt_trace(MOD_MMI, data);
    //kal_prompt_trace(MOD_MMI, "\r\n");
    btmtk_fs_write_wstream(result, (void*)data, strlen(data), (kal_uint32*)&length); 
    btmtk_fs_write_wstream(result, "\r\n", 2, (kal_uint32*)&length);    
}



#ifdef TEST_XML_ON_WIN32
...
extern void test_xml(void)
{
    ...
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    kal_char filename[128];

#ifdef __BATCH_TEST__
    FILE *list, *out_ok, *out_fail, *valid, *output;
    kal_char file_name[128];
    kal_char outfile_path[128];
    kal_char ref_file[128];
    kal_int32 i;
    kal_int32 count = 0;
#endif /* __BATCH_TEST__ */ 
    kal_char resultname[128];
    kal_char testname[128];
    kal_char unicodefile[128];
    kal_int32 driver;
    ...
    if ( result == NULL)
    {
        ...
        result = btmtk_fs_open_rstream(resultname, FS_READ_WRITE | FS_CREATE_ALWAYS);
        //kal_prompt_trace(MOD_MMI, "result handle :%d\r\n", result);
    }

#ifdef __BATCH_TEST__

    xml_register_element_handler(&parser, xml_elem_start_hdlr, xml_elem_end_hdlr);

    xml_register_data_handler(&parser, xml_general_data_hdlr);

    list = fopen("F:\\home\\mbj06066\\xml_test\\files.txt", "rb");
    out_ok = fopen("F:\\home\\mbj06066\\xml_test\\test_out\\result_ok.txt", "w");
    out_fail = fopen("F:\\home\\mbj06066\\xml_test\\test_out\\result_fail.txt", "w");
    valid = fopen("F:\\home\\mbj06066\\xml_test\\should_ok.txt", "rb");
    fscanf(valid, "%s\n", ref_file);
    ...
    while (fscanf(list, "%s\n", file_name) != EOF)
    {
        if (strstr(file_name, ".xml") != NULL)
        {
             ...
             * i = strlen(file_name);
             * for (i; file_name[i] != '\\'; i--);
             * memset (outfile_path, 0, sizeof (outfile_path));
             * strncpy (outfile_path, file_name, i);
             * strcat (outfile_path, "\\test_out\\");
             * _mkdir (outfile_path);
             * strcat (outfile_path, &file_name[i+1]);
             * 
             * output = fopen (outfile_path, "w");
             */

            mmi_asc_to_ucs2(filename, file_name);
            result = xml_parse(&parser, filename);
            count++;
            if (count == 1578)
            {
                kal_int32 i = 0;
            ...
            if (result < XML_RESULT_OK)
            {
                if (strcmp(file_name, ref_file) == 0)
                {
                    fscanf(valid, "%s\n", ref_file);
                    result = XML_RESULT_OK;
                }
                else
                {
                    fprintf(out_fail, "%s\t", file_name);
                    fprintf(out_fail, "F\n");
                }
            }
            ...
            if (result >= XML_RESULT_OK)
            {
                if (result == XML_RESULT_ENCODING_ERROR)
                {
                    fprintf(out_ok, "%s\t", file_name);
                    fprintf(out_ok, "NA\n");
                }
                else
                {
...
#ifdef __TESTBUFFER__
    {
        FILE *fp;
        kal_int32 length;
        kal_char *ptr, *buffer = malloc(6000);
        memset(buffer, 0, 6000);
        
        fp = fopen("F:\\home\\mbj06066\\xml_test\\testxmlbuffer.xml", "rb");
        ptr = buffer;
        while (fread(ptr, 1024, 1, fp)!= 0)
            ptr += 1024;
        length = strlen(buffer);
        xml_parse_buffer(&parser, buffer, length);
    }
#else//__TESTBUFFER__
    mmi_asc_to_ucs2(filename, "E:\\xml_test\\testxml.xml");
    xml_parse(&parser, filename);
#endif //__TESTBUFFER__
#endif /* __BATCH_TEST__ */ 

    xml_close_parser(&parser);
}

#else /* TEST_XML_ON_WIN32 */
extern void test_xml(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    ...
    //kal_prompt_trace(MOD_MMI, "enter function test_xml\r\n");
    if (xml_new_parser(&parser) < 0)
        return;
    if ( result == NULL)
    {
    ...
    kal_wsprintf(testname, "%c:\\testxml.xml",driver);
    xml_parse(&parser, testname);  
    xml_close_parser(&parser);  
}
#endif /* TEST_XML_ON_WIN32 */
#endif /* __TEST_XML__*/
#endif /* if 0 */
