 ...
 *==============================================================================
 *******************************************************************************/
#ifndef _BT_EXT_TIMER_H_
#define _BT_EXT_TIMER_H_
...
struct btTimer {
  ...
  struct btTimer *next;	/* Link to next timer */
  struct btTimer *enext;	/* Link to next expired timer */
};
...
extern void timer_Start(struct btTimer *);
extern void timer_Stop(struct btTimer *);
extern void timer_InitService(int);
extern void timer_TermService(void);
extern void timer_Show();
