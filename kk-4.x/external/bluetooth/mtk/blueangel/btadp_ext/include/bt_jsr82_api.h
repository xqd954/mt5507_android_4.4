...
BT_BOOL btmtk_jsr82_session_service_turn_on(kal_uint8 ps_type, U8 con_id, kal_uint32 transaction_id);
BT_BOOL btmtk_jsr82_session_service_turn_off(kal_uint8 ps_type, U8 con_id, kal_uint32 transaction_id);
