...
$(gyp_intermediate_dir)/XMLNames.cpp: $(gyp_shared_intermediate_dir)/blink/XMLNames.cpp
	mkdir -p $(@D); cp $< $@
$(gyp_intermediate_dir)/WMLNames.cpp: $(gyp_shared_intermediate_dir)/blink/WMLNames.cpp
	mkdir -p $(@D); cp $< $@
...
$(gyp_intermediate_dir)/StyleBuilderFunctions.cpp: $(gyp_shared_intermediate_dir)/blink/StyleBuilderFunctions.cpp
	mkdir -p $(@D); cp $< $@
$(gyp_intermediate_dir)/WMLElementFactory.cpp: $(gyp_shared_intermediate_dir)/blink/WMLElementFactory.cpp
	mkdir -p $(@D); cp $< $@
...
LOCAL_C_INCLUDES_Debug := \
	...
	$(LOCAL_PATH)/third_party/WebKit/Source/core/wml \
	$(LOCAL_PATH) \
