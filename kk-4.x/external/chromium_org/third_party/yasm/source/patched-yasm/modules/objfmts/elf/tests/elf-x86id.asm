...
; Many changes made to make nasm-syntax compatible.
	...
	;.file	"x86id.c"
;#APP
	;.ident	"$Id: //DTV/MP_BR/DTV_X_IDTV0801_002298_3_001/android/kk-4.x/external/chromium_org/third_party/yasm/source/patched-yasm/modules/objfmts/elf/tests/elf-x86id.asm#1 $"
;#NO_APP
