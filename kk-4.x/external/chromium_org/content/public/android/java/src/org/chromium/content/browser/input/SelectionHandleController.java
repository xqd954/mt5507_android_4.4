...
public abstract class SelectionHandleController implements CursorController {
    ...
    public void setOutOfInputBounds(boolean startOut, boolean endOut) {
        if (mStartHandle != null) mStartHandle.setOutOfInputBounds(startOut);
        if (mEndHandle != null) mEndHandle.setOutOfInputBounds(endOut);
    }
    /// @}
