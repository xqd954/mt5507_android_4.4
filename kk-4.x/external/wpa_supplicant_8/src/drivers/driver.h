...
struct wpa_driver_ops {
	...
	/**
	 * set_ptk - Set the PTK generated from wpa_supplicant to driver for receiving broadcast magic packet (group rekey)
	 * @priv: Private driver interface data
	 * @ptk: PTK set to driver
	 * @ptk_len: Length of the PTK
	 * Returns: 0 on success, -1 on failure
	 *
	 * This function is to set PTK from wpa_supplicant to driver
	 */
	int (*set_ptk)(void *priv, u8 *ptk, int ptk_len);
	/**
	 * set_replay_counter - Set the replay counter generated from wpa_supplicant to driver for receiving broadcast magic packet (group rekey)
	 * @priv: Private driver interface data
	 * @replay_counter: Replay counter set to driver
	 * @replay_counter_len: Length of the replay counter
	 * Returns: 0 on success, -1 on failure
	 *
	 * This function is to set replay counter from wpa_supplicant to driver
	 */
	int (*set_replay_counter)(void *priv, u8 *replay_counter, int replay_counter_len);
