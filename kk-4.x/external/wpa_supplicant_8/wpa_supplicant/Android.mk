...
ifeq ($(CONFIG_FORCE_AP_SME_SUPPORT), y)
L_CFLAGS += -DCONFIG_FORCE_AP_SME_SUPPORT
endif

ifeq ($(CONFIG_P2P_AUTO_GO_AS_SOFTAP), y)
L_CFLAGS += -DCONFIG_P2P_AUTO_GO_AS_SOFTAP
L_CFLAGS += -DCONFIG_FORCE_AP_SME_SUPPORT
endif

ifeq ($(CONFIG_DISALLOW_P2P_GO_FIND), y)
L_CFLAGS += -DCONFIG_DISALLOW_P2P_GO_FIND
endif
