 ...
 */
/*
 * $Id: //DTV/MP_BR/DTV_X_IDTV0801_002298_3_001/android/kk-4.x/external/apache-xml/src/main/java/org/apache/xalan/xslt/EnvironmentCheck.java#1 $
 */
 ...
 * @version $Id: //DTV/MP_BR/DTV_X_IDTV0801_002298_3_001/android/kk-4.x/external/apache-xml/src/main/java/org/apache/xalan/xslt/EnvironmentCheck.java#1 $
 */
public class EnvironmentCheck
{
  ...
  protected boolean writeEnvironmentReport(Hashtable h)
  {
    ...
    logMsg(
      "#---- BEGIN writeEnvironmentReport($Revision: #1 $): Useful stuff found: ----");
  ...
  public void appendEnvironmentReport(Node container, Document factory, Hashtable h)
  {
    ...
    try
    {
      ...
      envCheckNode.setAttribute("version", "$Revision: #1 $");
