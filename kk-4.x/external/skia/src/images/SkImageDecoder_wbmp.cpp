                                  ...
                                  Mode mode)
{
    ...
    //Modify it for fixing DTV00579795, play a mpg video file as wbmp format, because their header information is same.
	//So check resolution to distigush wbmp file. If it is mpg video data, the resolution as wbmp is very large.
	//Texture max resolution is 4096*4096
	if (width > 4096 || height > 4096)
	{
		SkDebugf("#########The wbmp resolution is beyond over texture limitation 4096*4096#########.\n");
		return false;
	}
