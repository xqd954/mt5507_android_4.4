...
public:
    ...
    */
    ...
    bool isDisplayThumbnail() {return fDisplayThumbnail;}
    void setDisplayThumbnail(bool bThumbnail) {fDisplayThumbnail = bThumbnail;}
    ...
    */
    ...
    bool decodeMtkGif(SkStream* stream, mtkSkBitmap* bm,
                            SkBitmap::Config pref, Mode mode);
    bool onMtkDecodeGif(SkStream* sk_stream, mtkSkBitmap* bm, Mode mode);

    bool onMtkDecodeAnimationGif(SkStream* sk_stream, mtkSkBitmap* bm, Mode mode, int frameIdx);

	bool decodeAnimationGif(SkStream* stream, mtkSkBitmap* bm,
