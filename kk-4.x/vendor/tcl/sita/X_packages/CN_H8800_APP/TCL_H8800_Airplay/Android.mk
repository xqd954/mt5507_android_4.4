...
LOCAL_MODULE := TCL_H8800_AirplayPlayerActivity
...
# Module name should match apk name to be installed
LOCAL_MODULE := TCL_H8800_AudioPlayerActivity
...
# Module name should match apk name to be installed
LOCAL_MODULE := TCL_H8800_Multiscreen_mDNSProtocolStack_TV
...
# Module name should match apk name to be installed
LOCAL_MODULE := TCL_H8800_WelcomeActivity
