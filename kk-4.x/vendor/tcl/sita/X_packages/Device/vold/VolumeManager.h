...
class MultiSensorDeviceManager{
public:

	int which_device;
	int to_do_stopstart;
public:
	MultiSensorDeviceManager();
    virtual ~MultiSensorDeviceManager();
	void stopstartdaemon(int which,int stopstart);
...
private:
    ...
    MultiSensorDeviceManager *mMultiSensorDeviceManager;
...
public:
    ...
    void handleHidEvent(NetlinkEvent *evt);
