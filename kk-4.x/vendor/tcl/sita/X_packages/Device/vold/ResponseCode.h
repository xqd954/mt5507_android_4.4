...
public:
	...
	static const int VolumeInfoLabelResult    = 113;
	static const int VolumeInfoFstypeResult   = 114;
	static const int VolumeInfoUuidResult     = 115;
	static const int VolumeInfoDevpathResult  = 116;
