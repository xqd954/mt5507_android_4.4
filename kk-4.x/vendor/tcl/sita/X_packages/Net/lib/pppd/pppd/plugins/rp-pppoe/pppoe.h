...
// debug:define varivates for pppoe.
char localIp[32];
char remoteIp[32];
char netMask[32];
char dns1[32];
...
// debug:pppoe status.
#define LINK_PPP_UP             30
#define LINK_PPP_DOWN   31
#define LINK_AUTH_FAIL  32
#define LINK_TIME_OUT   33
#define LINK_PPP_FAIL   34

// debug:define port for socket to report pppoe status.
#define PORT 8973
// debug:this ip for socket which report pppoe status.
...
void parseLogErrs(UINT16_t typ, UINT16_t len, unsigned char *data, void
*xtra);
