...
LOCAL_MODULE := TCL_HK_AirplayPlayerActivity
...
# Module name should match apk name to be installed
LOCAL_MODULE := TCL_HK_AudioPlayerActivity
...
# Module name should match apk name to be installed
LOCAL_MODULE := TCL_HK_Multiscreen_mDNSProtocolStack_TV
...
# Module name should match apk name to be installed
LOCAL_MODULE := TCL_HK_WelcomeActivity
