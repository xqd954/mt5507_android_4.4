...
LOCAL_MODULE := TCL_CMP_TVOS_TVManager_FastBoot
...
# Module name should match apk name to be installed
LOCAL_MODULE := TCL_CMP_TVOS_TVManager_NetManager
...
# Module name should match apk name to be installed
LOCAL_MODULE := TCL_CMP_TVOS_TVManager_SafeProtection
...
# Module name should match apk name to be installed
LOCAL_MODULE := TCL_CMP_TVOS_TVManager_SoftwareManager
...
# Module name should match apk name to be installed
LOCAL_MODULE := TCL_CMP_TVOS_TVManager_SystemInfo
...
# Module name should match apk name to be installed
LOCAL_MODULE := TCL_CMP_TVOS_TVManager_TaskManager
...
# Module name should match apk name to be installed
LOCAL_MODULE := TCL_CMP_TVOS_TVManager_TVExamination
...
# Module name should match apk name to be installed
LOCAL_MODULE := TCL_CMP_TVOS_TVManager_TVManager
