...
public class TCLFloatMenu extends Dialog {
	...
	public static TCLFloatMenu makeFloatMenu(Context context, int theme, int itemNo){		
		if(theme == 0){
			floatMenu = new TCLFloatMenu(context, com.android.internal.R.style.TCLFloatMenu);  
		}else{
		...
		switch(itemNo){
			case 2:{
				setView(context, com.android.internal.R.layout.tcl_menu_2);
				floatMenu.setContentView(mView);
				if(floatMenu != null){			
					leftLayout = floatMenu.findViewById(com.android.internal.R.id.left_RelativeLayout);
					rightLayout = floatMenu.findViewById(com.android.internal.R.id.right_RelativeLayout);
				    return floatMenu;
				}			
			}
			break;
			case 3:{
				setView(context, com.android.internal.R.layout.tcl_menu_3);
				floatMenu.setContentView(mView);
				if(floatMenu != null){			
					leftLayout = floatMenu.findViewById(com.android.internal.R.id.left_RelativeLayout);
					midLayout =  floatMenu.findViewById(com.android.internal.R.id.mid_RelativeLayout);
					rightLayout = floatMenu.findViewById(com.android.internal.R.id.right_RelativeLayout);
			...
			case 4:{
				setView(context, com.android.internal.R.layout.tcl_menu_4);
				floatMenu.setContentView(mView);
				if(floatMenu != null){			
					leftLayout = floatMenu.findViewById(com.android.internal.R.id.left_RelativeLayout);
					leftLayout2 = floatMenu.findViewById(com.android.internal.R.id.left_RelativeLayout2);
					rightLayout = floatMenu.findViewById(com.android.internal.R.id.right_RelativeLayout);
					rightLayout2 = floatMenu.findViewById(com.android.internal.R.id.right_RelativeLayout2);
				    return floatMenu;
				}			
			}
			break;
			case 5:{
				setView(context, com.android.internal.R.layout.tcl_menu_5);
				floatMenu.setContentView(mView);
				if(floatMenu != null){			
					leftLayout = floatMenu.findViewById(com.android.internal.R.id.left_RelativeLayout);
					leftLayout2 = floatMenu.findViewById(com.android.internal.R.id.left_RelativeLayout2);
	...
	public void setLeftText(int resId){
		TextView tv =(TextView) mView.findViewById(com.android.internal.R.id.left_text);
		tv.setText(resId);
	}

	public void setSecondLeftText(int resId){
		TextView tv =(TextView) mView.findViewById(com.android.internal.R.id.left_text2);
		tv.setText(resId);
	}
	/**
	...
	public void setLeftImageResource(int resId){
		ImageView icon = (ImageView)mView.findViewById(com.android.internal.R.id.left_icon);
		icon.setImageResource(resId);	
	}

	public void setSecondLeftImageResource(int resId){
		ImageView icon = (ImageView)mView.findViewById(com.android.internal.R.id.left_icon2);
		icon.setImageResource(resId);	
	}
	...
	public void setMidText(int resId){
		TextView tv = (TextView)mView.findViewById(com.android.internal.R.id.mid_text);
		tv.setText(resId);
	}
	...
	public void setMidImageDrawable(Drawable drawable){
		ImageView icon = (ImageView)mView.findViewById(com.android.internal.R.id.mid_icon);
		icon.setImageDrawable(drawable);
	}
	...
	public void setRightText(int resId){
		TextView tv = (TextView)mView.findViewById(com.android.internal.R.id.right_text);
		tv.setText(resId);
	}

	public void setSecondRightText(int resId){
		TextView tv = (TextView)mView.findViewById(com.android.internal.R.id.right_text2);
		tv.setText(resId);
	}
	...
	public void setRightImageDrawable(Drawable drawable){
		ImageView icon = (ImageView)mView.findViewById(com.android.internal.R.id.right_icon);
		icon.setImageDrawable(drawable);
	}

	public void setSecondRightImageDrawable(Drawable drawable){
		ImageView icon = (ImageView)mView.findViewById(com.android.internal.R.id.right_icon2);
		icon.setImageDrawable(drawable);
	}
