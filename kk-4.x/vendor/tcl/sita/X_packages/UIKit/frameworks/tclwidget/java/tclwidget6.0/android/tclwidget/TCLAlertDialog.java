...
public class TCLAlertDialog extends Dialog{
	...
	public static TCLAlertDialog makeNoTitle(Context context, int theme){
		...
		if(dialog != null){
			//setBackgroundWindow();
			setView(context, tvos.R.layout.tcl_alert_notitle);
			mContentLayout = getLayout(tvos.R.id.alert_content);
			mButtonLayout = getLayout(tvos.R.id.alert_button);
	...
	public static TCLAlertDialog makeNoButton(Context context, int theme){
		...
		if(dialog != null){
			//setBackgroundWindow();
			setView(context, tvos.R.layout.tcl_alert_nobutton);
			
			mTitleLayout = getLayout(tvos.R.id.alert_title);
			mContentLayout = getLayout(tvos.R.id.alert_content_foot);
			dialog.setContentView(mView);
			return dialog;
		}else{
		return null;
	...
	public static TCLAlertDialog makeFullDialog(Context context, int theme){
		...
		if(dialog != null){
			//setBackgroundWindow();
			setView(context, tvos.R.layout.tcl_alert_full);
			
			mTitleLayout = getLayout(tvos.R.id.alert_title_full);
			mButtonLayout = getLayout(tvos.R.id.alert_button_full);
			mContentLayout = getLayout(tvos.R.id.alert_content_full);
			dialog.setContentView(mView);
			return dialog;
		}else{
		return null;
	...
	public static TCLAlertDialog makeDefaultFullDialog(Context context,int theme,int buttonStyle,int imageStyle){
		...
		//lp.topMargin = 10;
		CharSequence ASK = context.getString(tvos.R.string.tcl_dialog_ask);
		CharSequence HINT = context.getString(tvos.R.string.tcl_dialog_hint);
		CharSequence SELECT = context.getString(tvos.R.string.tcl_dialog_select);
		...
		if(buttonStyle == TCLAlertDialog.TWO_BUTTON){
			...
			bt1.setText(tvos.R.string.tcl_dialog_ok1);
			Button bt2 = dialog.getRightButton();
			bt2.setText(tvos.R.string.tcl_dialog_cancle);
			...
			bt3.setText(tvos.R.string.tcl_dialog_ok1);
		}else if(buttonStyle == TCLAlertDialog.THREE_BUTTON) {
			dialog.setButton(context, TCLAlertDialog.THREE_BUTTON, lp1);
			Button bt1 = dialog.getLeftButton();
			bt1.setText(tvos.R.string.tcl_dialog_ok1);
			Button bt2 = dialog.getRightButton();
			bt2.setText(tvos.R.string.tcl_dialog_cancle);
			...
			bt3.setText(tvos.R.string.tcl_dialog_ignore);
		}
		return dialog;
	}
	...
	public void setContentText(Context context,CharSequence text){
		...
		View view = inflate.inflate(tvos.R.layout.tcl_alert_content_text,null);
		TextView tv = ((TextView)view.findViewById(tvos.R.id.label));
	...
	public void setTitle(Context context, TCLAlertDialog dialog, int resid, CharSequence text,RelativeLayout.LayoutParams lp){
		...
		View v = inflate.inflate(tvos.R.layout.tcl_alert_title,null);
		ImageView imageView = (ImageView) v.findViewById(tvos.R.id.alert_title_icon);
		switch(resid){
		case 0:
			resid = tvos.R.drawable.tcl_alert_pulldown;
			break;
		case 1:
			resid = tvos.R.drawable.tcl_question;
			break;
		case 2:
			resid = tvos.R.drawable.tcl_info;
			break;
		case 3:
			resid = tvos.R.drawable.tcl_warning;
			break;
		default:
			break;
		}
		...
		TextView textView = (TextView)v.findViewById(tvos.R.id.alert_title_text);
	...
	public View setButton(Context context, int buttonType, RelativeLayout.LayoutParams lp){
		...
		switch(buttonType){
		case ONE_BUTTON:
			mButtonView = inflate.inflate(tvos.R.layout.tcl_alert_button_one, null);
			break;
		case TWO_BUTTON:
			mButtonView = inflate.inflate(tvos.R.layout.tcl_alert_button_two, null);
			break;
		case THREE_BUTTON:
			mButtonView = inflate.inflate(tvos.R.layout.tcl_alert_button_three, null);
			break;
	...
	public TCLButton getLeftButton(){
		TCLButtonBlack btn = (TCLButtonBlack)mButtonView.findViewById(tvos.R.id.button1);
		return btn;
	}
	...
	public TCLButton getRightButton(){
		TCLButtonBlack btn = (TCLButtonBlack)mButtonView.findViewById(tvos.R.id.button2);
		return btn;
	}

	
	/**
	 * Gets the Object of ignore button.
	 * @return The Object of ignore button.
	 */
	public TCLButton getCenterButton(){
		TCLButtonBlack btn = (TCLButtonBlack)mButtonView.findViewById(tvos.R.id.button_center);
		return btn;
	}
