...
public class TCLZoomControls extends LinearLayout{
    ...
    public TCLZoomControls(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(com.android.internal.R.layout.tcl_zoom_controls, this, // we are the parent
                true);
        
        mZoomIn = (ZoomButton) findViewById(com.android.internal.R.id.zoomIn);
        mZoomOut = (ZoomButton) findViewById(com.android.internal.R.id.zoomOut);
    }
