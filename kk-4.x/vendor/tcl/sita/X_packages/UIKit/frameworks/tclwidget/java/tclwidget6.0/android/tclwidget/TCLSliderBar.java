...
public class TCLSliderBar extends View {
	...
	//	mbgdrawbale = mContext.getResources().getDrawable(com.android.internal.R.drawable.tcl_slider_bg);
		mbthumbrawbale = mContext.getResources().getDrawable(tvos.R.drawable.tcl_slider_thumb);
	}
...
//del by lyp		mbgdrawbale.setBounds(mid - mlinewidth/2, top,mid + mlinewidth/2, height);
//del by lyp		mbgdrawbale.draw(canvas);		
