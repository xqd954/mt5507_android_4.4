...
@RemoteView
public class TCLButtonBlack extends TCLButton {
    public TCLButtonBlack(Context context) {
        this(context, null);
    }

    public TCLButtonBlack(Context context, AttributeSet attrs) {
        this(context, attrs, com.android.internal.R.attr.tclbuttonblackStyle);
    }

    public TCLButtonBlack(Context context, AttributeSet attrs, int defStyle) {
