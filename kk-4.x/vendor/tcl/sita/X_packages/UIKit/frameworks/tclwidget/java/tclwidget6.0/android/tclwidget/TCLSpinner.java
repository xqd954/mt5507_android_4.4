...
public class TCLSpinner extends Spinner {
	...
	public TCLSpinner(Context context, AttributeSet attrs) {
		 this(context, attrs, tvos.R.attr.tclspinnerStyle);
	...
	public boolean performClick() {
		...
		View view = layoutInflater.inflate(tvos.R.layout.tcl_spinner_popwindow, null);
		//view.setBackgroundDrawable(context.getResources().getDrawable(com.android.internal.R.drawable.tcl_listview_818_bg));
		final TCLListView lv_group = (TCLListView) view.findViewById(tvos.R.id.tcl_spinner_listview);
