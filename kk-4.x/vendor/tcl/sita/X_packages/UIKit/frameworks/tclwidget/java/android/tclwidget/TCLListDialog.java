...
public class TCLListDialog extends Dialog{
	...
	public static TCLListDialog makeListDialog(Context context, int theme,CharSequence text,int width,int height,View view,RelativeLayout.LayoutParams lp){
		...
		View mView = inflate.inflate(com.android.internal.R.layout.tcl_listdialog,null);
		TextView tv = (TextView)mView.findViewById(com.android.internal.R.id.list_title);
		tv.setText(text);
		tv.setWidth(width);
		tv.setHeight(height);
		if(view != null)
		{
			RelativeLayout rl = (RelativeLayout)mView.findViewById(com.android.internal.R.id.list_content_foot);
			rl.addView(view);
		}
