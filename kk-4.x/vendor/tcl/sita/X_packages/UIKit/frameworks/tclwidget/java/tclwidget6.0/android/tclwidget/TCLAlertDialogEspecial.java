...
public class TCLAlertDialogEspecial extends Dialog{
	...
	public static TCLAlertDialogEspecial makeFullDialog(Context context, int theme){
		...
		if(dialog != null){
			//setBackgroundWindow();
			setView(context, tvos.R.layout.tcl_alert_full_especial);
			
			mButtonLayout = getLayout(tvos.R.id.tcl_especial_idalert_gray_full_button);
			mContentLayout = getLayout(tvos.R.id.tcl_especial_idalert_gray_full_content);
	...
	public void setContentText(Context context,CharSequence text){
		...
		View view = inflate.inflate(tvos.R.layout.tcl_alert_content_text_especial,null);
		TextView tv = ((TextView)view.findViewById(tvos.R.id.tcl_especial_idlabel));
    ...
    */
	...
	public View setButton(Context context, int buttonType){
		...
		switch(buttonType){
		case ONE_BUTTON:
			mButtonView = inflate.inflate(tvos.R.layout.tcl_alert_button_one_especial, null);
			break;
		case TWO_BUTTON:
			mButtonView = inflate.inflate(tvos.R.layout.tcl_alert_button_two_especial, null);
			break;
		case THREE_BUTTON:
			mButtonView = inflate.inflate(tvos.R.layout.tcl_alert_button_three_especial, null);
			break;
		default:
	...
	public TCLButtonEspecial getLeftButton(){
		TCLButtonEspecial btn = (TCLButtonEspecial)mButtonView.findViewById(tvos.R.id.tcl_especial_idbutton1);
		return btn;
	}
	...
	public TCLButtonEspecial getRightButton(){
		TCLButtonEspecial btn = (TCLButtonEspecial)mButtonView.findViewById(tvos.R.id.tcl_especial_idbutton2);
		return btn;
	}
	...
	public TCLButtonEspecial getCenterButton(){
		TCLButtonEspecial btn = (TCLButtonEspecial)mButtonView.findViewById(tvos.R.id.tcl_especial_idbutton3);
		return btn;
	}	
