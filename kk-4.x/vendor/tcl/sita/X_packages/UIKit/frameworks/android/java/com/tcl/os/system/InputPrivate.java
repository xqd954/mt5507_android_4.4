/*
	lvh@tcl , copy from frameworks/base/cmds/input/src/com/android/commands/input/Input.java
*/
...
public class InputPrivate {
	...
	public void InputRunWithCmds(String[] args) {
        run(args);
    }
	//}}
}
