...
LOCAL_PACKAGE_NAME := tvos-framework-res
LOCAL_CERTIFICATE := platform
#LOCAL_JAVA_LIBRARIES := framework

LOCAL_USE_TVOS_FRAMEWORK_RES:=false
...
$(call add-dependency(tvos-framework-res,framework-res))

include $(BUILD_PACKAGE)

include $(CLEAR_VARS)

LOCAL_MODULE := pre_tvos_res
...
#include $(LOCAL_PATH)/tclwidget/Android.mk
...
.PHONY: tvos-framework-res-package-target
tvos-framework-res-package-target: $(LOCAL_BUILT_MODULE)
