...
def ImagePropFromGlobalDict(glob_dict, mount_point):
  ...
  elif mount_point == "impdat":
    copy_prop("fs_type", "fs_type")
    copy_prop("impdata_size", "partition_size")
  elif mount_point == "tclconfig":
    copy_prop("fs_type", "fs_type")
    copy_prop("tclconfig_size", "partition_size")
  elif mount_point == "midbase":
    copy_prop("fs_type", "fs_type")
    copy_prop("tvos_size", "partition_size")
  elif mount_point == "database":
    copy_prop("fs_type", "fs_type")
    copy_prop("tcldata_size", "partition_size")
...
def main(argv):
  ...
  if image_filename == "system.img":
    ...
    mount_point = "data"
  elif image_filename == "impdata.img":
    mount_point = "impdat"
  elif image_filename == "tclconfig.img":
    mount_point = "tclconfig"
  elif image_filename == "tvos.img":
    mount_point = "midbase"
  elif image_filename == "tcldata.img":
