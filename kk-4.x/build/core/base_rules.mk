...
#########################################################
## from mtk/dtv release custom build
########################################################
PREBUIT_PATH := ../mediatek/device/prebuilt

ifeq "$(RLS_CUSTOM_BUILD)" "true"
JB_DIR := $(word 1, $(subst /platform/,/platform /, $(shell bash -c pwd -L)))
ANDROID_DIR := $(word 1, $(subst /kk-4.x/,/kk-4.x /, $(shell bash -c pwd -L)))
#LOCAL_CLASSPATH += $(ANDROID_DIR)/$(PREBUIT_PATH)/classes/com.mediatek.common.util.jar
LOCAL_CLASSPATH += $(ANDROID_DIR)/$(PREBUIT_PATH)/classes/com.mediatek.common.capture.jar
LOCAL_CLASSPATH += $(ANDROID_DIR)/$(PREBUIT_PATH)/classes/com.mediatek.common.PhotoPlayer.jar
LOCAL_CLASSPATH += $(ANDROID_DIR)/$(PREBUIT_PATH)/classes/com.mediatek.dm.jar
ifneq "$(HYBRID_MODE)" "true"
ifneq "${ANDROID_TWO_WORLDS}" "true"
LOCAL_CLASSPATH += $(ANDROID_DIR)/$(PREBUIT_PATH)/classes/com.mediatek.tv.jar
LOCAL_CLASSPATH += $(ANDROID_DIR)/$(PREBUIT_PATH)/classes/com.mediatek.record.jar
LOCAL_CLASSPATH += $(ANDROID_DIR)/$(PREBUIT_PATH)/classes/com.mediatek.tvcm.jar
endif
LOCAL_CLASSPATH += $(ANDROID_DIR)/$(PREBUIT_PATH)/classes/com.mediatek.dlna.jar
LOCAL_CLASSPATH += $(ANDROID_DIR)/$(PREBUIT_PATH)/classes/com.mediatek.mmp.jar
LOCAL_CLASSPATH += $(ANDROID_DIR)/$(PREBUIT_PATH)/classes/com.mediatek.common.audiocapture.jar
endif
LOCAL_CLASSPATH += $(ANDROID_DIR)/$(PREBUIT_PATH)/classes/jcifs.jar
