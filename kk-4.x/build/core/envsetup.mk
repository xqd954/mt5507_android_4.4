...
TARGET_OUT_IMPDATA := $(PRODUCT_OUT)/impdat
TARGET_OUT_TCLCONFIG := $(PRODUCT_OUT)/tclconfig
TARGET_OUT_TVOS := $(PRODUCT_OUT)/midbase
TARGET_OUT_TCLDATA := $(PRODUCT_OUT)/database
